  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          { name: 'Torrevieja', color: 'blueLight' },
          { name: 'Algorfa', color: 'blueLight' },
          { name: 'Jávea', color: 'blueLight' },
          { name: 'Calpe', color: 'blueLight' },
          { name: 'Benidorm', color: 'blueLight' },
          { name: 'Altea', color: 'blueLight' },
          { name: 'Moraira', color: 'blueLight' },
          { name: 'Orihuela Costa', color: 'blueLight' },
          { name: 'Guardamar del Segura', color: 'blueLight' },
          { name: 'Villamartín', color: 'blueLight' },
          { name: 'La Zenia', color: 'blueLight' },
          { name: 'Dénia', color: 'blueLight' },
          { name: 'Ciudad Quesada', color: 'blueLight' },
          { name: 'Cabo Roig', color: 'blueLight' },
          { name: 'Santa Pola', color: 'blueLight' },
          { name: 'Other', color: 'grayLight' },
        ],
      },
      {
        name: 'Language',
        ...
        options: [
          { name: 'English', color: 'redLight' },
          { name: 'Svenska', color: 'blueLight' },
          { name: 'Nederlands', color: 'orangeLight' },
          { name: 'Français', color: 'purpleLight' },
          { name: 'Deutsch', color: 'yellowLight' },
          { name: 'Norsk', color: 'blueLight' },
          { name: 'Polski', color: 'redLight' },
          { name: 'Русский', color: 'redLight' },
        ],
      },
      {
        name: 'Property Type',
        ...
        options: [
          { name: 'Apartment', color: 'blueLight' },
          { name: 'Villa', color: 'greenLight' },
          { name: 'Townhouse', color: 'yellowLight' },
          { name: 'Bungalow', color: 'orangeLight' },
          { name: 'Penthouse', color: 'purpleLight' },
          { name: 'Duplex', color: 'pinkLight' },
          { name: 'Other', color: 'grayLight' },
        ],
      },
      {
        ...
        options: [
          { name: 'Under €150k', color: 'greenLight' },
          { name: '€150k-€250k', color: 'blueLight' },
          { name: '€250k-€350k', color: 'yellowLight' },
          { name: '€350k-€500k', color: 'orangeLight' },
          { name: '€500k+', color: 'purpleLight' },
        ],
      },
      {
        name: 'Source Page',
      ...
      },
      {
        ...
        options: [
          { name: 'Area Inquiry', color: 'blueLight' },
          { name: 'Development Inquiry', color: 'greenLight' },
          { name: 'General Contact', color: 'yellowLight' },
          { name: 'Guide Download', color: 'purpleLight' },
          { name: 'Property Alert', color: 'orangeLight' },
        ],
      },
      {
        name: 'Status',
        ...
        options: [
          { name: 'New Lead', color: 'greenLight' },
          { name: 'Contacted', color: 'blueLight' },
          { name: 'Qualified', color: 'yellowLight' },
          { name: 'Viewing Booked', color: 'orangeLight' },
          { name: 'Offer Made', color: 'purpleLight' },
          { name: 'Closed Won', color: 'greenDark' },
          { name: 'Closed Lost', color: 'redLight' },
        ],
      },
      {
        name: 'Assigned To',
