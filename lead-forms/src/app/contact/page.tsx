    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-4 mb-8">
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl transition-colors"
            >
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Fastest response - usually within minutes</div>
              </div>
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl transition-colors"
            >
              ...
              <div>
                <div className="font-semibold text-gray-900">+34 634 044 970</div>
                <div className="text-sm text-gray-600">Call us directly - we speak English, Swedish, Spanish</div>
              </div>
              <svg className="w-5 h-5 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl transition-colors"
            >
              ...
              <div>
                <div className="font-semibold text-gray-900">oskar@hanssonhertzell.com</div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Our Office</h2>
          ...
          <div className="rounded-xl overflow-hidden border border-gray-200">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3138.8!2d-0.6831!3d37.9774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd63a9!2sCalle%20Caballero%20de%20Rodas%2031%2C%20Torrevieja!5e0!3m2!1sen!2ses!4v1"
              width="100%"
              height="250"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="mt-8 p-6 bg-blue-50 rounded-xl">
            <h2 className="text-lg font-semibold text-gray-900 mb-3">About Hansson & Hertzell</h2>
        ...
        <div>
          ...
          <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-xl">
            <h3 className="font-semibold text-gray-900 mb-2">Need Mortgage Financing?</h3>
      ...
      <section className="mt-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-gray-900 mb-2">What languages do you speak?</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-gray-900 mb-2">Can you help with mortgages?</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-gray-900 mb-2">Do you charge fees?</h3>
            <p className="text-gray-600 text-sm">
