...
import { ParsedProperty, ParsedDevelopment } from '../lib/xml-parser';

// Featured developments with complete data
export const sampleDevelopments: ParsedDevelopment[] = [
  {
...
export default {
  developments: sampleDevelopments,
