...
import { ParsedDevelopment } from './xml-parser';
...
export async function generateBuilderContent(
  ...
  developments: ParsedDevelopment[]
): Promise<GeneratedContent> {
 ...
 */
function buildDevelopmentPrompt(dev: ParsedDevelopment): string {
 ...
 */
function getFallbackContent(development: ParsedDevelopment): GeneratedContent {
 ...
 */
export function needsRegeneration(slug: string, maxAgeDays: number = 7): boolean {
