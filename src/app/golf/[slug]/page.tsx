            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-light text-white mb-4">
                  Looking to Live Near the Golf Course?
                </h2>
                <p className="text-warm-200 text-lg leading-relaxed mb-6">
                  Our agents specialize in golf property on the Costa Blanca — with 12+ years of experience, we'll help you find your perfect golf home.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/consultation"
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-semibold text-sm">Expert Local Knowledge</h4>
                        <p className="text-warm-300 text-xs mt-1">12+ years in Costa Blanca golf market</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-accent-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        <h4 className="text-white font-semibold text-sm">Personalized Guidance</h4>
                        <p className="text-warm-300 text-xs mt-1">Find properties matching your budget and lifestyle</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-accent-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
