...
export const metadata: Metadata = {
  title: 'Propriétés en bord de mer Costa Blanca | Nouveaux Immeubles Près de la Plage',
  description: 'Découvrez les nouveaux immeubles près des plus belles plages de Costa Blanca. Des appartements en front de mer aux villas à pied. Plages de La Zenia, Playa Flamenca, Torrevieja.',
  keywords: 'propriété plage espagne, appartement front de mer costa blanca, villa près plage, propriété la zenia, appartements playa flamenca',
  openGraph: {
    title: 'Propriétés en bord de mer Costa Blanca',
    description: 'Nouveaux immeubles près des plus belles plages de Costa Blanca. À pied de la Méditerranée.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/fr/beach',
    languages: {
...
const POPULAR_BEACHES = [
  {
    ...
    town: 'Orihuela Costa',
    description: 'Eaux cristallines et anse de Cala Bosque. L\'une des plages les plus populaires du sud de Costa Blanca.',
    image: '/images/beaches/la-zenia.jpg',
    zones: ['la zenia'],
    amenities: ['Pavillon bleu', 'Maître nageur', 'Restaurants', 'Parking'],
  },
  {
    name: 'Playa Flamenca',
    town: 'Orihuela Costa',
    description: 'Plage familiale avec eaux calmes et excellentes installations. À pied des magasins et restaurants.',
    image: '/images/beaches/playa-flamenca.jpg',
    zones: ['playa flamenca', 'aguamarina'],
    amenities: ['Pavillon bleu', 'Maître nageur', 'Bars de plage', 'Promenade'],
  },
  {
    name: 'Playa del Cura',
    town: 'Torrevieja',
    description: 'Plage centrale de Torrevieja avec vues spectaculaires et atmosphère vibrante. Près des célèbres lacs de sel.',
    image: '/images/beaches/playa-del-cura.jpg',
    zones: ['playa de el cura', 'playa del cura', 'playa el cura'],
    amenities: ['Pavillon bleu', 'Promenade', 'Restaurants', 'Centre-ville'],
  },
  {
    name: 'Playa de La Mata',
    town: 'Torrevieja',
    description: 'Longue plage de sable s\'étendant sur 2 km avec dunes naturelles. Parfait pour les promenades et sports nautiques.',
    image: '/images/beaches/la-mata.jpg',
    zones: ['la mata'],
    amenities: ['Dunes naturelles', 'Bars de plage', 'Parking', 'Sports'],
  },
  {
    name: 'Cabo Roig',
    town: 'Orihuela Costa',
    description: 'Belle anse (Cala Capitán) avec formations rocheuses. Célèbre pour le marché du samedi.',
    image: '/images/beaches/cabo-roig.jpg',
    zones: ['cabo roig'],
    amenities: ['Plage d\'anse', 'Marina', 'Restaurants', 'Marché'],
  },
  {
    name: 'Mil Palmeras',
    town: 'Pilar de la Horadada',
    description: 'Plage paisible avec sable fin et eaux cristallines. Moins fréquentée, parfait pour les familles.',
    image: '/images/beaches/mil-palmeras.jpg',
    zones: ['mil palmeras'],
    amenities: ['Pavillon bleu', 'Eaux calmes', 'Familiale', 'Promenade'],
  },
];

export default async function BeachPropertiesPageFr() {
  ...
  const pageSchema = collectionPageSchema({
    name: 'Propriétés en bord de mer Costa Blanca',
    description: 'Nouveaux immeubles près des plages à Costa Blanca',
    url: 'https://newbuildhomescostablanca.com/fr/beach',
    items: beachDevelopments.slice(0, 20).map(d => ({
      name: d.name,
      url: `https://newbuildhomescostablanca.com/fr/developments/${d.slug}`,
      price: d.priceFrom
    }))
  });
  ...
  return (
    <main className="min-h-screen bg-warm-50">
      ...
      <section className="relative h-[50vh] min-h-[400px] max-h-[500px]">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Vue aérienne des plages de Costa Blanca avec eaux turquoise de la Méditerranée"
            fill
          ...
          <div className="max-w-7xl mx-auto px-6 pb-10 w-full">
            ...
            <nav className="mb-4">
              <ol className="flex items-center gap-2 text-sm text-warm-300">
                ...
                <li>/</li>
                <li className="text-white">Propriétés en bord de mer</li>
              </ol>
            </nav>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-3">
              Propriétés en bord de mer <span className="font-semibold">Costa Blanca</span>
            </h1>

            <p className="text-warm-200 text-lg max-w-2xl mb-6">
              {beachDevelopments.length} nouveaux projets de construction près des plus belles plages de la Méditerranée.
              Des appartements en front de mer aux villas à pied.
            </p>
      ...
      <section className="bg-white border-b border-warm-200 sticky top-[72px] z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-1 overflow-x-auto py-3">
            ...
            >
              Toutes les Propriétés en bord de mer ({beachDevelopments.length})
            </Link>
            <Link
              href="#beachfront"
            ...
            >
              🌊 Front de mer ({beachfront.length})
            </Link>
            <Link
              href="#walking"
              className="px-4 py-2 rounded-sm text-sm font-medium bg-warm-100 text-primary-900 hover:bg-warm-200 transition-colors whitespace-nowrap"
            >
              🚶 À pied ({walkingDistance.length})
            </Link>
            <Link
              href="#nearby"
              className="px-4 py-2 rounded-sm text-sm font-medium bg-warm-100 text-primary-900 hover:bg-warm-200 transition-colors whitespace-nowrap"
            >
              🚗 Courte distance en voiture ({shortDrive.length})
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-light text-primary-900">
              Zones de <span className="font-semibold">Plage Populaires</span>
            </h2>
            <p className="text-warm-600 mt-2">
              Explorez les propriétés près des plages les plus recherchées de Costa Blanca
            </p>
          </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-warm-200">
                      <div>
                        ...
                        <span className="text-warm-600 text-sm ml-1">propriétés</span>
                      </div>
                      {minPrice > 0 && (
                        <div className="text-sm">
                          <span className="text-warm-600">À partir de </span>
        ...
        <section id="beachfront" className="py-12 bg-warm-50">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Propriétés en <span className="font-semibold">Front de Mer</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Réveillez-vous au son des vagues. Ces propriétés sont directement sur la plage.
            </p>
      ...
      {walkingDistance.length > 0 && (
        <section id="walking" className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              À Pied <span className="font-semibold">de la Plage</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Juste une petite promenade jusqu'au sable. L'équilibre parfait entre accès à la plage et intimité.
            </p>
            ...
            {walkingDistance.length > 8 && (
              <div className="text-center mt-8">
                <Link
                  href="/fr/developments?beach=walking"
                ...
                >
                  Afficher les {walkingDistance.length} Propriétés à Pied
      ...
      <section id="all" className="py-12 bg-warm-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
            Toutes les Propriétés <span className="font-semibold">en Bord de Mer</span>
          </h2>
          <p className="text-warm-600 mb-8">
            Parcourez tous les {beachDevelopments.length} nouveaux projets de construction près des plages de Costa Blanca.
          </p>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2 flex gap-1">
                    ...
                    {dev.status === 'key-ready' && (
                      <span className="bg-accent-500 text-white text-xs px-2 py-0.5 rounded-sm">Prêt</span>
                    )}
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                    <div className="text-lg font-semibold text-white">{formatPrice(dev.priceFrom)}</div>
          ...
          {beachDevelopments.length > 16 && (
            <div className="text-center mt-8">
              <Link
                href="/fr/developments?tag=beach-lover"
              ...
              >
                Afficher les {beachDevelopments.length} Propriétés en Bord de Mer
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
      ...
      <section className="py-12 bg-white border-t border-warm-200">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-primary-900 mb-4">
            Propriétés en Bord de Mer à Costa Blanca, Espagne
          </h2>
          <div className="prose prose-warm max-w-none text-warm-700">
            <p>
              Costa Blanca offre certaines des plus belles plages de la Méditerranée, avec plus de 200 km de
              côtes présentant des plages pavillon bleu, des criques cachées et de longues étendues de sable. Notre sélection
              de nouveaux immeubles vous place à proximité facile de ces magnifiques plages.
            </p>
            <h3>Zones de Plage Populaires</h3>
            <p>
              <strong>Orihuela Costa</strong> - Maison de La Zenia, Playa Flamenca et Cabo Roig, cette région
              offre un parfait mélange de vie balnéaire et d'équipements modernes. Les propriétés ici vont des
              appartements aux villas de luxe, beaucoup à pied de la plage.
            </p>
            <p>
              <strong>Torrevieja</strong> - Une ville côtière animée avec plusieurs plages dont Playa del
              Cura et La Mata. Les célèbres lacs de sel créent un microclimat unique, et la ville offre
              d'excellentes infrastructures pour la vie toute l'année.
            </p>
            <p>
              <strong>Pilar de la Horadada</strong> - À la pointe sud de Costa Blanca, des plages comme
              Mil Palmeras offrent un environnement plus tranquille avec des eaux cristallines.
            </p>
          </div>
        </div>
      </section>
