...
export const metadata: Metadata = {
  ...
  description: 'Votre partenaire de confiance pour les propriétés neuves à Costa Blanca et Costa Calida. Expertise spécialisée pour les acheteurs français, belges et suisses en Espagne.',
  openGraph: {
    title: 'À Propos | Maisons Neuves Costa Blanca',
    description: 'Votre partenaire de confiance pour les propriétés neuves à Costa Blanca.',
    type: 'website',
  ...
  twitter: {
    card: 'summary',
    title: 'À Propos | Maisons Neuves Costa Blanca',
    description: '15+ années aidant les acheteurs internationaux à trouver leur maison de rêve en Espagne. Sélection complète de propriétés neuves.',
  },
  alternates: {
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6">
                Votre Partenaire pour Trouver la <span className="font-semibold">Maison Neuve Parfaite</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Nous nous spécialisons exclusivement dans les propriétés neuves à Costa Blanca et Costa Calida.
                Notre connaissance approfondie du marché local, nos relations de confiance avec les promoteurs,
                et notre engagement envers un service personnalisé font de nous le choix idéal pour les acheteurs
                internationaux en quête de leur maison de rêve en Espagne.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-light text-primary-900 mb-6">
                  Accès à <span className="font-semibold">Chaque Propriété Neuve</span>
                </h2>
                <div className="space-y-4 text-warm-700 leading-relaxed">
                  <p>
                    Nous offrons un accès à la <strong>sélection complète de propriétés neuves</strong> à Costa Blanca
                    et Costa Calida. Si une propriété est en construction dans la région, nous pouvons vous la montrer.
                  </p>
                  <p>
                    En plus de 15 ans, nous avons établi des relations avec tous les grands promoteurs de la région.
                    Cela signifie que vous voyez tout - des projets de villas boutique aux grands développements
                    touristiques - tous en un seul endroit.
                  </p>
                  <p>
                    Mais nous ne sommes pas seulement des chercheurs de propriétés. Nous avons assemblé un réseau
                    de professionnels de confiance pour soutenir votre parcours complet : <strong>constructeurs,
                    architectes, décorateurs d'intérieur, avocats, conseillers fiscaux, et spécialistes en hypothèques</strong>.
                    Le package complet pour l'achat de votre maison en Espagne.
                  </p>
                </div>
              </div>
              <div className="relative">
                <div className="aspect-[4/3] rounded-sm overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <div className="text-warm-200">Promoteurs de Confiance</div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <ValueCard
                ...
                description="Accès à chaque propriété neuve à Costa Blanca et Costa Calida. Si c'est en construction, nous pouvons vous la montrer."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description="Constructeurs, architectes, avocats, conseillers fiscaux - nous avons réuni l'équipe complète dont vous avez besoin."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description="Chaque constructeur avec lequel nous travaillons a été minutieusement contrôlé pour la qualité et la fiabilité."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description="De la première visite à la remise des clés et au-delà - nous vous accompagnons à chaque étape."
              />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-primary-900 mb-4">
                Comment Nous <span className="font-semibold">Vous Aidons</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Acheter une propriété neuve en Espagne est un voyage passionnant. Voici comment nous le rendons simple et sans stress.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                ...
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Recherche de Propriété</h3>
                <p className="text-warm-600 text-sm">
                  Dites-nous vos exigences et votre budget. Nous établissons une présélection des meilleures options neuves de notre portefeuille extensif.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">2</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Visites</h3>
                <p className="text-warm-600 text-sm">
                  Nous organisons et vous accompagnons lors des visites, en vous fournissant des conseils d'experts sur chaque développement et zone.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">3</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Conseils d'Expert</h3>
                <p className="text-warm-600 text-sm">
                  Nous gérons toutes les négociations et la paperasse en votre nom, en tirant parti de nos relations solides avec les promoteurs.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">4</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Soutien Juridique</h3>
                <p className="text-warm-600 text-sm">
                  Nous vous mettons en relation avec des avocats de confiance parlant français qui se spécialisent dans les transactions immobilières espagnoles.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">5</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Mises à Jour de Construction</h3>
                <p className="text-warm-600 text-sm">
                  Pour les achats en avant-projet, nous vous tenons informé de la progression de la construction avec des photos et rapports réguliers.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">6</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Remise des Clés</h3>
                <p className="text-warm-600 text-sm">
                  Nous assistons à l'inspection finale et à la remise des clés avec vous, en veillant à ce que tout soit parfait.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-warm-700 mb-6 leading-relaxed">
                  Nous couvrons l'ensemble de la Costa Blanca du nord au sud, de Dénia à Torrevieja,
                  plus la région de Costa Calida autour de Murcia. Cela inclut tous les domaines populaires
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Costa Blanca Sud</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Torrevieja</li>
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Complexes Golfiques</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Las Colinas</li>
                      <li>• Villamartín</li>
                      <li>• La Finca</li>
              ...
              <div className="bg-primary-900 p-8 rounded-sm text-white">
                ...
                <p className="text-warm-300 mb-6">
                  Prêt à commencer votre recherche de propriété ? Contactez-nous aujourd'hui pour une consultation gratuite et sans engagement.
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <p className="text-warm-400 text-sm">
                    Heures d'ouverture : Lundi - Vendredi, 9h - 18h (CET)
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-primary-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
              Prêt à Trouver Votre Maison de Rêve en Espagne ?
            </h2>
            <p className="text-warm-300 mb-8 max-w-2xl mx-auto">
              Parcourez notre portefeuille extensif de propriétés neuves ou contactez-nous pour des recommandations personnalisées.
            </p>
