...
export const metadata: Metadata = {
  title: 'Régions Costa Blanca | Guides de Vie et Propriétés',
  description: 'Découvrez les meilleures régions pour vivre à Costa Blanca. Guides complets de Jávea, Moraira et bien d\'autres avec annonces immobilières et informations lifestyle.',
  openGraph: {
    title: 'Régions Costa Blanca | Guides de Vie et Propriétés',
    description: 'Découvrez les meilleures régions pour vivre à Costa Blanca. Explorez Jávea, Moraira, Calpe et d\'autres emplacements premium.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Régions Costa Blanca | Guides de Vie et Propriétés',
    description: 'Découvrez les meilleures régions pour vivre à Costa Blanca. Guides complets des emplacements principaux.',
  },
  alternates: {
    ...
    <main className="min-h-screen bg-warm-50">
      ...
      <section className="relative bg-primary-900 py-16 md:py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <nav className="text-warm-400 text-sm mb-6">
            ...
            <span className="text-white">Régions</span>
          </nav>
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                Découvrez votre emplacement idéal
              </span>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
              Costa Blanca <span className="font-semibold">Régions</span>
            </h1>

            <p className="text-warm-300 text-lg leading-relaxed mb-8">
              Du sud ensoleillé et abordable au prestigieux littoral nord.
              Explorez nos guides détaillés pour trouver votre coin idéal de Costa Blanca.
            </p>
            ...
            <div className="flex flex-wrap gap-8">
              ...
              <div>
                ...
                <div className="text-warm-400 text-sm">Jours de soleil</div>
              </div>
              <div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-accent-400 text-sm font-medium">Meilleur rapport qualité-prix en Espagne</p>
                </div>
                <div className="text-right">
              ...
              <p className="text-warm-300 text-sm mb-4 line-clamp-2">
                Région Mar Menor de Murcia. Golf de championnat, ensoleillement toute l'année, 25-40% moins cher que Costa Blanca.
              </p>
              <div className="flex flex-wrap gap-2">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {southData.popularTowns.map(town => (
                  <div key={town} className="bg-white p-4 rounded-sm border border-warm-200">
                    ...
                    <p className="text-sm text-warm-500">Guide régional à venir</p>
                  </div>
                ))}
              </div>
            )}
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-primary-900 font-medium text-lg">Envie d'explorer les projets dans ces régions ?</p>
            <p className="text-warm-500 text-sm mt-1">Contactez-nous pour les disponibilités, plans d'étage ou pour réserver une visite</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                Vous ne savez pas quelle région choisir ?
              </h2>
              <p className="text-warm-300 leading-relaxed mb-6">
                Avec autant d'endroits fantastiques à choisir, cela peut être accablant.
                Dites-nous vos priorités—budget, style de vie, proximité de la plage ou du golf—et
                nous vous recommanderons la région parfaite pour vous.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-5 rounded-sm">
                ...
                <div className="text-warm-300 text-sm">Ans d'expérience locale</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">500+</div>
                <div className="text-warm-300 text-sm">Familles aidées</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">Free</div>
                <div className="text-warm-300 text-sm">Consultation gratuite</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">5</div>
                <div className="text-warm-300 text-sm">Langues</div>
              </div>
            </div>
          </div>
        </div>
