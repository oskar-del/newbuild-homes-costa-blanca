...
export const metadata: Metadata = {
  title: 'Costa Cálida Fastighetsguide 2026 | Mar Menor, Murcia & Golfresorts',
  description: 'Upptäck Costa Cálida - Spaniens bästa värderam. Mar Menor-stranden, 6+ golfbanor, nyprodukioner från €170k. Los Alcázares, San Javier, Torre Pacheco. Fullständig guide.',
  openGraph: {
    title: 'Costa Cálida - Spaniens bästa värderam för fastigheter',
    description: 'Mar Menor-lagunen, golfresorts, sol året runt. Fastigheter från €170 000.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/sv/areas/costa-calida/',
    languages: {
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {dev.deliveryQuarter && (
            <div className={`text-[10px] font-medium px-2 py-1 rounded-sm ${
              ...
              {dev.status === 'key-ready' ? 'Flytta nu' : dev.deliveryQuarter}
            </div>
          )}
        </div>
...
export default async function CostaCalidaPageSv() {
  ...
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'Costa Cálida', url: 'https://newbuildhomescostablanca.com/sv/areas/costa-calida/' },
  ]);
      ...
      <main className="min-h-screen bg-warm-50 pb-20 lg:pb-0">
        ...
        <section className="relative bg-primary-900 py-16 md:py-24 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <nav className="text-warm-400 text-sm mb-6">
              ...
              <Link href="/sv/areas" className="hover:text-white transition-colors">Områden</Link>
              <span className="mx-2">›</span>
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-warm-300 text-lg md:text-xl mb-6">
                Mar Menor • Golfresorts • Medelhavsstil
              </p>

              <p className="text-warm-300 text-lg leading-relaxed mb-8 max-w-3xl">
                Upptäck Spaniens "Varma kust" - där Mar Menors läkande vatten möter
                världsklassgolfbanor, och nya bostäder kostar <strong className="text-white">25-40% mindre</strong> än
                Costa Blanca. Sol året runt, autentisk spansk kultur, och
                fastigheter från bara <strong className="text-accent-400">{formatPrice(lowestPrice || 170000)}</strong>.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-white/10 rounded-sm p-4 text-center">
                  ...
                  <div className="text-warm-400 text-sm">Mar Menor-lagunen</div>
                </div>
                <div className="bg-white/10 rounded-sm p-4 text-center">
                  <div className="text-2xl md:text-3xl font-bold text-accent-400">{formatPrice(lowestPrice || 170000)}</div>
                  <div className="text-warm-400 text-sm">Fastigheter från</div>
                </div>
                <div className="bg-white/10 rounded-sm p-4 text-center">
                  <div className="text-2xl md:text-3xl font-bold text-white">320+</div>
                  <div className="text-warm-400 text-sm">Soliga dagar/år</div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
                Varför välja <span className="font-semibold">Costa Cálida</span>?
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Europas största saltvattenlagyn, världsklassgolf och Spaniens bästa fastighetsvärde.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                ...
                <p className="text-warm-600 text-sm">Europas största saltvattenlagyn. Varmt, lugnt vatten perfekt för familjer och vattensporter. Läkande leriga bad.</p>
              </div>
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                <div className="text-4xl mb-3">⛳</div>
                <h3 className="font-semibold text-primary-900 mb-2">{golfCourses.length} Golfbanor</h3>
                <p className="text-warm-600 text-sm">Serena Golf, Roda Golf, Hacienda del Álamo och mer. Världsklassbanan till utmärkt värde.</p>
              </div>
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                <div className="text-4xl mb-3">💰</div>
                <h3 className="font-semibold text-primary-900 mb-2">Bästa värde</h3>
                <p className="text-warm-600 text-sm">Fastigheter 25-40% billigare än Costa Blanca. Samma sol, samma livsstil, bättre priser.</p>
              </div>
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                <div className="text-4xl mb-3">☀️</div>
                <h3 className="font-semibold text-primary-900 mb-2">320+ Soliga dagar</h3>
                <p className="text-warm-600 text-sm">Medelhavsklim året runt. Golf- och strandaktiviteter möjliga varje månad.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-14 bg-warm-50" id="golf">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Golf <span className="font-semibold">Fastigheter</span>
            </h2>
            <p className="text-warm-600 mb-8">
              {golfCourses.length} världsklassbanor med nya bostäder. Golf året runt i Murcias sol.
            </p>
                  ...
                  <div className={`h-44 relative bg-gradient-to-br ${course.gradient}`}>
                    ...
                    <div className="absolute top-3 right-3 z-10">
                      <span className="bg-success-500 text-white text-xs font-bold px-2 py-1 rounded">
                        {course.propertyCount} Fastigheter
                      </span>
                    </div>
            ...
            {golfProperties.length > 0 && (
              <>
                <h3 className="text-xl font-semibold text-primary-900 mb-4">Utvalda golfprojekt</h3>
        ...
        <section className="py-14 bg-gradient-to-b from-warm-50 to-white" id="beach">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Mar Menor <span className="font-semibold">Strandastigheter</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Europas största saltvattenlagyn. Varmt, lugnt vatten perfekt för familjer. Fastigheter i Los Alcázares, San Javier och Santiago de la Ribera.
            </p>
            ...
            <div className="bg-gradient-to-r from-primary-900 to-primary-800 rounded-xl p-6 md:p-8 mb-10 text-white">
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2">🌡️ Varmare vatten</h3>
                  <p className="text-warm-300 text-sm">Mar Menor är 5-7°C varmare än Medelhavet. Badårstiden sträcker sig från april till november.</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">👨‍👩‍👧‍👦 Familjevänligt</h3>
                  <p className="text-warm-300 text-sm">Grunt, lugnt vatten gör det perfekt för barn och vattensporter. Ingen vågor, ingen ström.</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">💆 Läkande lera</h3>
                  <p className="text-warm-300 text-sm">Känd lerabad i Lo Pagán använd i århundraden för hud- och ledvård.</p>
                </div>
              </div>
            </div>
            ...
            {beachProperties.length > 0 ? (
              ...
              <div className="bg-white rounded-xl p-8 text-center border border-warm-200">
                ...
                <h3 className="text-xl font-semibold text-primary-900 mb-2">Strandastigheter kommer</h3>
                <p className="text-warm-600 mb-4">Nya strandprojekt läggs till regelbundet. Registrera ditt intresse för att meddelas.</p>
                <a href={CONTACT.whatsapp} target="_blank" rel="noopener noreferrer"
        ...
        <section className="py-14 bg-white" id="inland">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Inlands<span className="font-semibold">Fastigheter</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Torre Pacheco, Fuente Álamo och omgivande områden. Bästa värde med strander och golf fortfarande inom 20 minuter.
            </p>

            {/* Inland Areas */}
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                { name: 'Torre Pacheco', desc: 'Jordbruksstad nära Mar Menor', distance: '15 min till strand' },
                { name: 'Fuente Álamo', desc: 'Hacienda del Álamo golfresort', distance: '30 min till strand' },
                { name: 'Sucina', desc: 'Nära Peraleja Golf', distance: '15 min till strand' },
                { name: 'Cartagena', desc: 'Historisk hamnstad', distance: '10 min till strand' },
              ].map(area => (
            ...
            {inlandProperties.length > 0 ? (
              ...
              <div className="bg-warm-50 rounded-xl p-8 text-center border border-warm-200">
                <p className="text-warm-600">Kontakta oss för de senaste inlandsfastighetsalternativen i Costa Cálida.</p>
              </div>
            )}
          </div>
        </section>
        ...
        {luxuryProperties.length > 0 && (
          <section className="py-14 bg-gradient-to-b from-amber-50 to-white" id="luxury">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
                Lyx <span className="font-semibold">Fastigheter €800K+</span>
              </h2>
              <p className="text-warm-600 mb-8">
                Premium villor och exklusiva projekt i Costa Cálidas finaste lägen.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                  Redo att utforska Costa Cálida?
                </h2>
                <p className="text-warm-300 leading-relaxed mb-6">
                  ...
                  hjälper vi dig att hitta den perfekta fastigheten i Costa Cálida.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-warm-200 text-sm">Gratis fastighetsmatching</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-success-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-warm-200 text-sm">Lokal expertis</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-success-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-warm-200 text-sm">Inga köpararvoden</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-success-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-warm-200 text-sm">Besöksresor arrangerade</span>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-xl">
                <h3 className="text-xl font-semibold text-primary-900 mb-1">Få Costa Cálida-fastigheter</h3>
                <p className="text-warm-500 text-sm mb-5">Vi skickar dig matchande fastigheter från {formatPrice(lowestPrice || 170000)}</p>
                <LeadForm propertyInterest="Costa Cálida fastighet" formName="costa-calida-inquiry" />
              </div>
            </div>
          </div>
        </section>
