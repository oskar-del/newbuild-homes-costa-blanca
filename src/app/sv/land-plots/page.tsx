...
export const metadata: Metadata = {
  title: 'Byggskivor Costa Blanca | Köp Mark & Bygg Din Drömvilla',
  description: 'Premiumbyggskivor till salu i Costa Blanca från €200 000+. Bygg din drömvilla med våra betrodda arkitekter och byggare. Fullständig anpassad service från markinköp till nyckelöverlämnande.',
  openGraph: {
    title: 'Byggskivor Costa Blanca | Bygg Din Drömvilla',
    description: 'Premiumbyggskivor med fullständig anpassad byggservice. Arkitekter, byggare, juridik - vi hanterar allt.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/sv/land-plots',
    languages: {
    ...
    >
      ...
      <div className="p-4">
        <h3 className="font-semibold text-primary-900 mb-2 line-clamp-1 group-hover:text-accent-600 transition-colors">
          {plot.title || `Byggskiva i ${plot.town}`}
        </h3>
        ...
        <div className="flex items-center gap-4 text-warm-600 text-sm mb-3">
          ...
          {plot.plotSize && (
            <span className="flex items-center gap-1">
              ...
              {plot.plotSize.toLocaleString()}m² skiva
            </span>
          )}
        </div>
...
export default async function LandPlotsPageSv() {
  ...
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'Byggskivor', url: 'https://newbuildhomescostablanca.com/sv/land-plots/' },
  ]);
        ...
        <section className="relative bg-primary-900 py-16 md:py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <nav className="text-warm-400 text-sm mb-6">
              ...
              <span className="text-white">Byggskivor</span>
            </nav>
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Premiumbyggskivor i Costa Blanca för de som vill designa och bygga sin egen drömvilla. Vi erbjuder en fullständig anpassad service - från att hitta den perfekta skivan till att överlämna nycklarna till din färdiga villa.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                <div>
                  ...
                  <div className="text-warm-400 text-sm">Skivorna Tillgängliga</div>
                </div>
                <div>
                ...
                {avgPlotSize > 0 && (
                  <div>
                    ...
                    <div className="text-warm-400 text-sm">Genomsnittlig Skivstorlek</div>
                  </div>
                )}
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-6">
                  Vår Anpassade <span className="font-semibold">Byggservice</span>
                </h2>
                <p className="text-warm-600 leading-relaxed mb-6">
                  Att bygga ditt eget hem i Spanien behöver inte vara komplicerat. Vi arbetar med betrodda arkitekter, byggare och juridiska experter som vägleder dig genom varje steg - från att hitta den perfekta skivan till att överlämna nycklarna.
                </p>
                <p className="text-warm-600 leading-relaxed">
                  Vårt team har hjälpt dussintals klienter att bygga sina drömvillor i Costa Blanca. Vi hanterar komplexiteten i spanska byggregler, samordnar med lokala myndigheter och säkerställer att ditt projekt förblir i tid och inom budget.
                </p>
              </div>

              <div className="bg-primary-50 p-8 rounded-sm border border-primary-100">
                <h3 className="font-semibold text-primary-900 text-xl mb-6">Vad Som Ingår</h3>
                <div className="space-y-4">
                  {[
                    { step: '1', title: 'Skivval', desc: 'Hitta den perfekta byggskivan för dina behov och budget' },
                    { step: '2', title: 'Juridisk Kontroll', desc: 'Fullständig juridisk kontroll, tillstånd och dokumentation' },
                    { step: '3', title: 'Arkitektur & Design', desc: 'Arbeta med våra arkitekter för att designa din drömvilla' },
                    { step: '4', title: 'Byggaren Val', desc: 'Granskade byggare med beprövad meritlista' },
                    { step: '5', title: 'Projektledning', desc: 'Regelbundna uppdateringar, webbplatser och kvalitetskontroll' },
                    { step: '6', title: 'Nyckelöverlämnande', desc: 'Slutlig inspektion och nycklar till ditt nya hem' },
                  ].map((item) => (
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div>
                  ...
                  <p className="text-warm-600 mt-1">
                    {plots.length} premiumskivor från {formatPrice(lowestPrice)}
                  </p>
                </div>

                <div className="flex gap-2">
                  <span className="text-warm-500 text-sm">Sorterad efter pris (lågt till högt)</span>
                </div>
              </div>
          ...
          <section className="py-14 bg-warm-50">
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <p className="text-warm-600 leading-relaxed mb-8">
                Vi har tillgång till många byggskivor som inte är listade online. Kontakta oss för att diskutera dina krav och vi hjälper dig att hitta den perfekta skivan för ditt byggprojekt.
              </p>
              <a
                href={CONTACT.whatsapp}
                target="_blank"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-3">
                Varför <span className="font-semibold">Bygga Din Egen?</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Att bygga ditt eget hem ger dig fullständig kontroll över design, specifikationer och finisher.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Fullständig Anpassning</h3>
                <p className="text-warm-600 text-sm">
                  Designa varje aspekt av ditt hem exakt som du vill. Välj din layout, finisher och funktioner.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-warm-600 text-sm">
                  Byggnad kan kosta 20-30% mindre än att köpa en motsvarande färdig fastighet, speciellt för större villor.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-warm-600 text-sm">
                  Övervaka varje byggstadium och säkerställ högsta kvalitet på material och arbetskraft.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Välj Din Plats</h3>
                <p className="text-warm-600 text-sm">
                  Välj exakt skivan som passar din livsstil - havsvy, golffront, lugnt landsbygd eller livlig stad.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-warm-600 text-sm">
                  Använd de senaste solpaneler, isolering och smart home-teknik från början.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Gör Det Till Ditt</h3>
                <p className="text-warm-600 text-sm">
                  Skapa ett hem som perfekt passar din families behov, från tillgänglighetsfunktioner till hemmakontor.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-14 bg-primary-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-white mb-6">
              Redo Att Bygga Din Drömvilla?
            </h2>
            <p className="text-warm-300 leading-relaxed mb-8">
              Vi har hjälpt klienter att bygga allt från blygsamma familjehem till lyxvillor för flera miljoner euro. Vårt nätverk av arkitekter, byggare och juridiska experter säkerställer att ditt projekt går smidigt från start till slut.
            </p>
