      ...
      <main className="min-h-screen bg-warm-50">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Ny på <span className="font-semibold">Costa Blanca?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Viktiga guider för att hjälpa dig att fatta välinformerade beslut om att köpa fastighet i Spanien.
              </p>
            </div>
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Modernt nybyggt villainteriör med öppen planlösning"
                    fill
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    10-årig garanti, energieffektivt, ingen mäklare, modern design - upptäck fördelarna med att köpa nytt.
                  </p>
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Costa Blanca-kustlinjen med blå hav och vita byggnader"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Norr vs Söder Costa Blanca
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Klimat, priser, expatkommuner, flygplatser - vilket område passar din livsstil bättre?
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Läs Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Nybyggd utveckling under konstruktion på Costa Blanca"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Inflyttningsklart vs Från Ritning
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Flytta in nu eller spara pengar? Jämför fördelar, nackdelar och betalningsalternativ.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Läs Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Kompletta <span className="font-semibold">Boendeguider</span>
              </h2>
              <p className="text-warm-300 mt-2 max-w-xl mx-auto text-sm">
                De mest omfattande stadsdelsguiderna på internet — med drönfotografi, fastighetspriser och insider-tips.
              </p>
            </div>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    ...
                    alt="Luftfoto av Torreviejas kustlinje och stränder"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    7 stadsdelar med helikopterdrönfotografi. Costa Blanca Söder.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">104+ foton</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 zoner</span>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    ...
                    alt="Luftvy av Jáveakusten med Montgóberget"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    4 stadsdelar under Montgóberget. Costa Blanca Norr.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">4 stadsdelar</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 stränder</span>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    ...
                    alt="Luftvy av Calpe och Peñón de Ifach"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    6 städer jämförda med drönfotografi. Komplett regionöversikt.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">6 städer</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">Regionguide</span>
                  </div>
                </div>
              </Link>
            </div>
            ...
            <div className="text-center mt-6">
              <Link href="/sv/guides" className="text-accent-400 hover:text-accent-300 text-sm font-medium transition-colors">
                Se Alla Guider →
              </Link>
            </div>
          </div>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[450px]">
            ...
            <Link
              href={`/sv/properties/${featured.southVilla1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.southVilla1.bedrooms} sovrum · {featured.southVilla1.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            <Link
              href={`/sv/properties/${featured.southVilla2.reference}`}
              className="group relative h-[350px] md:h-auto overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.southVilla2.bedrooms} sovrum · {featured.southVilla2.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
        ...
        <section className="relative">
          ...
          <div className="bg-warm-800 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Pinoso Villor från €518k
              </h2>
              <p className="text-warm-400 mt-2 text-sm">
                Fredligt landsbygdsliv med privata pooler, större tomter och exceptionellt värde
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            ...
            <Link
              href={`/sv/properties/${featured.inland1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.inland1.bedrooms} sovrum · {featured.inland1.builtArea}m²
                  </span>
                </div>
            ...
            <Link
              href={`/sv/properties/${featured.inland2.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.inland2.bedrooms} sovrum · {featured.inland2.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Fastighet
          ...
          <div className="bg-warm-800 py-4 text-center">
            ...
            >
              Utforska Alla Landsbygdsfastigheter
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-warm-600 leading-relaxed mb-5">
                  Vi arbetar direkt med utvecklare, granskar personligen varje fastighet,
                  och ger helhetsstöd för internationella köpare.
                </p>
                <Link
                  href="/sv/contact"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Granskade Utvecklare</h3>
                  <p className="text-warm-600 text-xs">Endast beprövad track record.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Flerspråkig</h3>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Bolånhjälp</h3>
                  <p className="text-warm-600 text-xs">Jämför spanska banker.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Virtuella Rundturer</h3>
                  <p className="text-warm-600 text-xs">Se från var som helst.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[550px]">
            ...
            <div className="relative h-[400px] md:h-auto overflow-hidden bg-success-900">
              ...
              <Image
                ...
                alt="La Finca Golfbana med fairways, vattenfontäner och bergsutsikt"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
              ...
              <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-12">
                ...
                <h2 className="text-3xl md:text-4xl font-light text-white mb-4 leading-tight">
                  Vakna Till<br />
                  <span className="font-semibold">Golfplanutsikt</span>
                </h2>

                <p className="text-success-100 mb-6 max-w-md leading-relaxed">
                  Bo på mästerkapsbanor vid La Finca, Lo Romero & Vistabella.
                  Året runt sol, inflyttningsklara villor och golf på dörrstappen.
                </p>
                ...
                <div className="flex flex-wrap gap-6 mb-6">
                  <div>
                    ...
                    <div className="text-success-200 text-xs uppercase tracking-wide">Golfbanor</div>
                  </div>
                  <div>
                    <div className="text-2xl font-semibold text-white">320</div>
                    <div className="text-success-200 text-xs uppercase tracking-wide">Soldagar</div>
                  </div>
                  <div>
                    <div className="text-2xl font-semibold text-white">€399k</div>
                    <div className="text-success-200 text-xs uppercase tracking-wide">Från</div>
                  </div>
                </div>
            ...
            <Link
              href={`/sv/properties/${featured.golf1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.golf1.bedrooms} sovrum · {featured.golf1.builtArea}m²
                  </span>
                </div>
          ...
          <div className="grid md:grid-cols-2 h-[350px]">
            {/* Golf Property 2 */}
            <Link
              href={`/sv/properties/${featured.golf2.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-200 text-xs">
                    {featured.golf2.bedrooms} sovrum · {featured.golf2.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            {/* Golf Property 3 */}
            <Link
              href={`/sv/properties/${carousels['south-golf'].properties[2]?.reference || featured.golf1.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-200 text-xs">
                    {carousels['south-golf'].properties[2]?.bedrooms || featured.golf1.bedrooms} sovrum · {carousels['south-golf'].properties[2]?.builtArea || featured.golf1.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-warm-600 mt-1 text-sm">
                  Jávea, Moraira, Calpe — dramatiska kustlinjer och exklusiva fastigheter.
                </p>
              </div>
              <Link
                href="/sv/properties?region=costa-blanca-north"
                className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm"
              >
                Utforska Norr
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Underteckning av fastighetshandlingar i Spanien"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Steg-för-steg guide från fastighetsökning till slutförande. NIE, advokater, notering och nyckelövergivning.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Läs Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Kalkylator och ekonomiska dokument"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Fullständig nedbrytning av köpkostnader: IVA, stämpelskatt, noteringsavgifter och löpande utgifter.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Läs Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Husnyckel och bolånedokument"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Spanska Bolån för Utlänningar
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Hur du får bolån i Spanien. Krav, räntor och hur mycket du kan låna.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Läs Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-12 bg-warm-100 border-y border-warm-200">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Vilken Typ av <span className="font-semibold">Köpare är Du?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Olika köpare har olika behov. Hitta guider anpassade till din situation.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                  Försteköpare i Spanien?
                </h3>
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Allt du behöver veta: NIE-nummer, köpprocessen, kostnader, juridiska krav och steg-för-steg vägledning.
                </p>
              ...
              >
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                  Planerar du att Hyra Din Fastighet?
                </h3>
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Lär dig om turisuthyrningslicenser i Valencia. Nya 2025-regler, krav, kostnader och hur vi kan hjälpa.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Guide för Turisuthyrning
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </span>
              ...
              >
                ...
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Osäker vilken kust? Jämför Alicantes Costa Blanca med Murcias Costa Cálida - priser, klimat och livsstil.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Jämförelsen
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="relative">
          ...
          <div className="bg-primary-900 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <p className="text-warm-400 mt-2 text-sm">
                Handplockade premiumfastigheter i Jávea, Moraira & Costa Blanca Norr
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Left Bespoke Villa */}
            <Link
              href={`/sv/properties/${featured.bespokeLeft.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.bespokeLeft.bedrooms} sovrum · {featured.bespokeLeft.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Fastighet
            ...
            {/* Right Bespoke Villa */}
            <Link
              href={`/sv/properties/${featured.bespokeRight.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.bespokeRight.bedrooms} sovrum · {featured.bespokeRight.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Fastighet
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Villa Atlantis */}
            <Link
              href={`/sv/developments/${miralboVillas.villaAtlantis.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {miralboVillas.villaAtlantis.bedrooms} sovrum · {miralboVillas.villaAtlantis.builtArea}m² · {miralboVillas.villaAtlantis.plotArea}m² tomt
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Fastighet
            ...
            {/* Villa Posidonia */}
            <Link
              href={`/sv/developments/${miralboVillas.villaPosidonia.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {miralboVillas.villaPosidonia.bedrooms} sovrum · {miralboVillas.villaPosidonia.builtArea}m² · {miralboVillas.villaPosidonia.plotArea}m² tomt
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Fastighet
          ...
          <Link
            href={`/sv/developments/${miralboVillas.villaMIR0159.slug}`}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 md:right-1/2 p-8">
              ...
              <p className="text-warm-300 text-sm mb-4">{miralboVillas.villaMIR0159.town} — Samtida Medelhavsbostad</p>
              <div className="flex items-center gap-6 mb-4">
                <span className="text-2xl font-semibold text-white">
                  {formatPrice(miralboVillas.villaMIR0159.price)}
                </span>
                <span className="text-warm-300 text-sm">
                  {miralboVillas.villaMIR0159.bedrooms} sovrum · {miralboVillas.villaMIR0159.bathrooms} badrum · {miralboVillas.villaMIR0159.builtArea}m² · {miralboVillas.villaMIR0159.plotArea}m² tomt
                </span>
              </div>
              <div className="flex items-center gap-2 text-accent-400 font-medium group-hover:gap-3 transition-all">
                Upptäck Villa MIR0159
          ...
          <div className="bg-primary-900 py-4 text-center">
            <Link
              href="/sv/properties?minPrice=800000"
              className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-400 transition-colors group text-sm"
            >
              Utforska Full Skräddarsydd Samling
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
