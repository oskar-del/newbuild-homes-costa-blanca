...
export const metadata: Metadata = {
  title: 'Nybygg Costa Blanca | Finn Ditt Perfekte Prosjekt',
  description: 'Utforsk nybygg over hele Costa Blanca og Costa Calida. Nøkkelklare boliger, golfeiendommer, strandboliger. Finn drømmehuset ditt i Spania.',
  openGraph: {
    title: 'Nybygg Costa Blanca',
    description: 'Utforsk nybygg over hele Costa Blanca. Nøkkelklare boliger fra pålitelige byggentreprenører.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Nybygg Costa Blanca | Finn Ditt Perfekte Prosjekt',
    description: 'Utforsk nybygg over hele Costa Blanca. Nøkkelklare boliger, golfeiendommer, strandboliger.',
  },
  alternates: {
...
export default async function DevelopmentsPage() {
  ...
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'Nybygg Costa Blanca', url: 'https://newbuildhomescostablanca.com/no/developments/' },
  ]);

  // CollectionPage schema for development listings
  const collectionSchema = collectionPageSchema({
    name: 'Nybygg Costa Blanca',
    description: 'Utforsk nybygg over hele Costa Blanca og Costa Calida. Nøkkelklare boliger, golfeiendommer, strandboliger.',
    url: 'https://newbuildhomescostablanca.com/no/developments/',
      ...
      <main className="min-h-screen bg-warm-50">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <div className="max-w-3xl">
              <nav className="text-warm-400 text-sm mb-6">
                ...
                <span className="text-white">Nybygg</span>
              </nav>

              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-px bg-accent-500" />
                <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                  Ditt Nye Hjem Venter
                </span>
              </div>

              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
                Opplev våre nyeste byggeprosjekter
                <span className="font-semibold block">Perfekt for deg</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8 max-w-2xl">
                Fra de solrike strendene på Costa Blanca Syd til de pittoreske bukterne på Nordkysten,
                oppdag {stats.totalDevelopments}+ nøye utvalgte prosjekter fra pålitelige lokale byggentreprenører.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-10">
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-sm">Nybygg Prosjekter</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-semibold text-accent-400">{keyReady.length}</div>
                  <div className="text-warm-400 text-sm">Nøkkelklare</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-semibold text-white">{stats.builderCount}+</div>
                  <div className="text-warm-400 text-sm">Byggentreprenører</div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-sm p-2 border border-white/20">
                <div className="flex flex-col md:flex-row gap-2">
                  <input
                    type="text"
                    placeholder="Søk etter prosjekter etter navn, by eller byggentreprenør..."
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    Nøkkelferdige <span className="font-semibold">Prosjekter</span>
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Ikke noe venting, ingen forsinkelser. Disse prosjektene er ferdigstilt og klare for deg. Perfekt for kjøpere som vil starte sitt meditteranke liv med en gang—nyt kaffen på terrassen eller dykk i bassenget.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/no/developments?status=key-ready"
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors group"
                  >
                    Se {keyReady.length} Nøkkelklare
              ...
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                    Bare et Steinkast fra <span className="font-semibold">Middelhavet</span>
                  </h2>
                  <p className="text-cyan-100 leading-relaxed mb-4">
                    Våkn ved krystallklart vann og gå til stranden på få minutter.
                    Fra La Zenia til Torrevieja, disse prosjektene plasserer deg direkte på Costa Blancas berømte strander.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'beachfront').length} Ved Stranden
                    </span>
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'walking').length} Gangturer
                    </span>
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'short-drive').length} Kort Kjøretur
                    </span>
                  </div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-sm p-6 text-white border border-white/10">
                  <h3 className="font-semibold text-lg mb-4 text-cyan-200">Hvorfor Strandliv?</h3>
                  <ul className="space-y-3 text-cyan-100">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>15+ blåflaggstrander</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>320+ soldager</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Krystallklart middelhavet</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Sterkt leiepotensial</span>
                    </li>
                  </ul>
                  <Link
                    href="/no/beach"
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    <span className="font-semibold">Torrevieja</span> og Omegn
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Spania sitt mest populære reisemål for internasjonale kjøpere. Med sine berømte saltsjøer, livlig sentrum og utmerkede eiendommer, tilbyr Torrevieja det komplette middelhavslivet. Bare 30 minutter fra Alicante lufthavn.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/no/areas/torrevieja"
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors group"
                  >
                    Oppdag Torrevieja
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-8 px-4">
          <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <p className="text-primary-900 font-medium text-lg">Søker du etter drømmeboligen?</p>
              <p className="text-warm-500 text-sm mt-1">Kontakt oss for siste tilgjengelige, planer eller for å booke en visning</p>
            </div>
            <div className="flex gap-3">
              ...
              <a href="/no/contact" className="px-5 py-2.5 border border-primary-900 text-primary-900 rounded-sm text-sm font-medium hover:bg-primary-900 hover:text-white transition-colors">
                Kontakt Oss
              </a>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <p className="text-warm-600 leading-relaxed mb-4">
                    Hjem til noen av Costa Blancas fineste golfbaner og blåflaggstrander.
                    Fra La Zenia Boulevard til stillingen Campoamor,
                    tilbyr Orihuela Costa premium livsstil til tilgjengelige priser.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                ...
                <div className="bg-primary-900 rounded-sm p-6 text-white">
                  <h3 className="font-semibold text-lg mb-4">Hvorfor Orihuela Costa?</h3>
                  <ul className="space-y-3 text-warm-300">
                    <li className="flex items-start gap-3">
                      ...
                      <span>5 mesterskap golfbaner</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Blåflaggstrander & marinaer</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Sterkt leiemarked</span>
                    </li>
                  </ul>
                  <Link
                    href="/no/areas/orihuela-costa"
                    className="inline-block mt-6 bg-accent-500 hover:bg-accent-600 text-white font-medium px-6 py-2 rounded-sm transition-colors"
                  >
                    Oppdag Området
                  </Link>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    <span className="font-semibold">Pilar de la Horadada</span> og Omegn
                  </h2>
                  <p className="text-warm-600 leading-relaxed mb-4">
                    Costa Blancas sørlighet punkt, hvor ubesmittete strander møter autentisk spansk kultur.
                    Pilar de la Horadada tilbyr utmerket prisverdi med spektakulær kystlinje, Lo Romero golfkurs,
                    og enkel tilgang til både Alicante og Murcia flyplasser.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                ...
                <div className="bg-teal-800 rounded-sm p-6 text-white">
                  <h3 className="font-semibold text-lg mb-4">Hvorfor Pilar de la Horadada?</h3>
                  <ul className="space-y-3 text-teal-100">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-teal-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>6 km ubesmittede sandstrander</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-teal-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Autentisk spansk byatmosfære</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-teal-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Utmerket prisverdi for strandbolig</span>
                    </li>
                  </ul>
                  <Link
                    href="/no/areas/pilar-de-la-horadada"
                    className="inline-block mt-6 bg-accent-500 hover:bg-accent-600 text-white font-medium px-6 py-2 rounded-sm transition-colors"
                  >
                    Oppdag Området
                  </Link>
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <p className="text-warm-300 leading-relaxed">
                    Våkn til spektakulære fairway-visninger og vær på første tee på få minutter.
                    Disse prosjektene er perfekt plassert på eller nær mesterskap golfbaner,
                    som tilbyr ultimate golflifestyle for golfentusiaster.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/no/golf-properties"
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    <span className="font-semibold">Finestrat</span> og Benidorm-området
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Det beste fra begge verdener: ro fra fjelllandsbyer med Benidorms strander og fasiliteter noen få minutter unna. Finestrat har blitt et hotspot for moderne luksusprosjekter
                    med fantastiske panoramautsikter. Terra Mítica temapark og Puig Campana tursti
                    tilbyr aktiviteter hele året.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/no/areas/finestrat"
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    Jávea, Moraira og <span className="font-semibold">Calpe</span>
                  </h2>
                  <p className="text-warm-600 leading-relaxed mb-4">
                    Kronperlene på Costa Blanca Nordens krone. Disse prestisjetunge områdene tilbyr dramatiske landskap,
                    sjarmerende marinaer og sofistikert livsstil. Berømt for det ikoniske Peñón de Ifach,
                    krystallklare bukter og Michelin-rangerte restauranter.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                ...
                <div className="bg-primary-900 rounded-sm p-6 text-white">
                  <h3 className="font-semibold text-lg mb-4">Premium Nordlivsstil</h3>
                  <ul className="space-y-3 text-warm-300">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Spektakulær sjø- og fjelleutsikt</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Michelin-stjernerestauranter</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Yachting og vannaktiviteter</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-accent-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Eksklusiv lukkede samfunn</span>
                    </li>
                  </ul>
                  <Link
                    href="/no/costa-blanca-north"
                    className="inline-block mt-6 bg-accent-500 hover:bg-accent-600 text-white font-medium px-6 py-2 rounded-sm transition-colors"
                  >
                    Oppdag Nord
                  </Link>
              ...
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  <div className="flex items-center gap-4 mb-3">
                    <div className="w-10 h-px bg-accent-500" />
                    <span className="text-accent-500 text-xs font-medium tracking-widest uppercase">
                      Den varme kysten · Murcia-region
                    </span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                  ...
                  <p className="text-warm-600 leading-relaxed mb-4">
                    Sør for Costa Blanca ligger Costa Calida—Murcias spektakulære kystlinje som tilbyr
                    den unike Mar Menor-lagunen. Europas største saltvannssøen tilbyr varmt og rolig vann
                    perfekt for vannaktiviteter, samtidig som det opprettholder noen av Spanias beste eiendomsverdier.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                ...
                <div className="bg-cyan-900 rounded-sm p-6 text-white">
                  <h3 className="font-semibold text-lg mb-4">Hvorfor Costa Calida?</h3>
                  <ul className="space-y-3 text-cyan-100">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Mar Menor - Europas største lagune</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Utmerket prisverdi vs Costa Blanca</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Nær Corvera internasjonale flyplass</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Verdenssenter for vannaktiviteter</span>
                    </li>
                  </ul>
                  <Link
                    href="/no/areas/costa-calida"
                    className="inline-block mt-6 bg-accent-500 hover:bg-accent-600 text-white font-medium px-6 py-2 rounded-sm transition-colors"
                  >
                    Oppdag Costa Cálida
                  </Link>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    Nye <span className="font-semibold">Lanseringer</span>
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Få prioritetsvekt på disse nylig lanserte prosjektene. Off-plan kjøp tilbyr best priser—
                    vanligvis 15-20% under ferdig eiendomsverdier. Sikre enheten nå med 30% innskudd
                    og betale resten ved fullføring. Jo tidligere du kjøper, desto bedre plassering og pris.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/no/developments?status=off-plan"
                    className="inline-flex items-center gap-2 text-blue-600 font-medium hover:text-blue-700 transition-colors group"
                  >
                    Se Alle Etter Planer
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-10">
                ...
                <p className="text-warm-300 max-w-2xl mx-auto">
                  Eksklusive prosjekter for erfarne kjøpere. Premium steder, eksepsjonelle spesifikasjoner,
                  og uovertruffen kvalitet på Spanias mest prestisjetunge adresser.
                </p>
              </div>
        ...
        <section className="py-16 bg-accent-500">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
              Usikker på hvor å begynne?
            </h2>
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              Med {stats.totalDevelopments}+ prosjekter å velge fra, kan det virke overveldende å finne riktig.
              Fortell oss dine behov—budsjett, plassering, innflyttingsdato—og vi vil foreslå perfekte prosjekter.
            </p>
