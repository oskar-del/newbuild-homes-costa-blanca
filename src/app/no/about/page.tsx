...
export const metadata: Metadata = {
  ...
  description: 'Din pålitelige partner for nybyggen på Costa Blanca og Costa Calida. Ekspertveiledning for norske kjøpere som søker sin drømmebolig i Spania.',
  openGraph: {
    title: 'Om Oss | New Build Homes Costa Blanca',
    description: 'Din pålitelige partner for nybyggen på Costa Blanca.',
    type: 'website',
  ...
  twitter: {
    card: 'summary',
    title: 'Om Oss | New Build Homes Costa Blanca',
    description: '15+ år med å hjelpe internasjonale kjøpere finne sin drømmebolig i Spania. Komplett utvalg av nybyggen.',
  },
  alternates: {
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6">
                Din Partner i å Finne Det Perfekte <span className="font-semibold">Nybygget Hjem</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Vi spesialiserer oss utelukkende i nybyggen på Costa Blanca og Costa Calida.
                Vår dype kunnskap om det lokale markedet, pålitelige developer-relasjoner, og dedikasjon
                til personalisert service gjør oss til det beste valget for internasjonale kjøpere som søker sin
                drømmebolig i solrige Spania.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-light text-primary-900 mb-6">
                  Tilgang til <span className="font-semibold">Alle Nybyggen</span>
                </h2>
                <div className="space-y-4 text-warm-700 leading-relaxed">
                  <p>
                    Vi gir deg tilgang til <strong>komplett utvalg av nybyggen</strong> på Costa Blanca og Costa Calida.
                    Hvis det bygges i regionen, kan vi vise det til deg.
                  </p>
                  <p>
                    I løpet av 15+ år har vi bygget relasjoner med alle store developers i regionen.
                    Det betyr at du ser alt - fra boutique villa-prosjekter til storskalerte resort-utbygginger - alt på ett sted.
                  </p>
                  <p>
                    Men vi er mer enn bare eiendomsmeglere. Vi har bygget et nettverk av pålitelige fagfolk for å støtte din hele reise:
                    <strong> builders, arkitekter, interiørdesignere, advokater, skatteeksperter, og boliglån-spesialister</strong>.
                    Hele pakken for å kjøpe ditt hjem i Spania.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-light text-primary-900">
                Hva Som Gjør Oss <span className="font-semibold">Unike</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <ValueCard
                ...
                title="Komplett Utvalg"
                description="Tilgang til alle nybyggen på Costa Blanca og Costa Calida. Hvis det bygges, kan vi vise det."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title="Pålitelig Nettverk"
                description="Builders, arkitekter, advokater, skatteeksperter - vi har samlet hele teamet du trenger."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title="Verifiserte Developers"
                description="Alle builders vi arbeider med er grundig sjekket for kvalitet og pålitelighet."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title="Helhetlig Støtte"
                description="Fra første visning til nøkkelhåndover og utover - vi er med deg hele veien."
              />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-primary-900 mb-4">
                Hvordan Vi <span className="font-semibold">Hjelper Deg</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Å kjøpe en nybygg-eiendom i Spania er en spennende reise. Her er hvordan vi gjør det jevn og stressfritt.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                ...
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Eiendomssøk</h3>
                <p className="text-warm-600 text-sm">
                  Fortell oss dine krav og budsjett. Vi vil kuratere de beste nybygde alternativene fra vår omfattende portefølje.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">2</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Visninger</h3>
                <p className="text-warm-600 text-sm">
                  Vi arrangerer og ledsager deg på visninger, med ekspertkunnskap om hver utbygging og område.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">3</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Ekspertveiledning</h3>
                <p className="text-warm-600 text-sm">
                  Vi håndterer alle forhandlinger og papirarbeid på dine vegne, med våre sterke developer-relasjoner.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">4</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Juridisk Støtte</h3>
                <p className="text-warm-600 text-sm">
                  Vi kobler deg med pålitelige engelskspråklige advokater som spesialiserer seg i spanske eiendomstransaksjoner.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">5</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Byggeoppupdateringer</h3>
                <p className="text-warm-600 text-sm">
                  For kjøp på tegning holder vi deg oppdatert om byggefremgang med vanlige fotos og rapporter.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">6</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Nøkkelhåndover</h3>
                <p className="text-warm-600 text-sm">
                  Vi deltar på sluttinspeksjon og nøkkelhåndover med deg, og sikrer at alt er perfekt.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-warm-700 mb-6 leading-relaxed">
                  Vi dekker hele Costa Blanca fra Denia i nord til Torrevieja i sør,
                  pluss Costa Calida-regionen rundt Murcia. Dette inkluderer alle de populære områdene for
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Costa Blanca Sør</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Torrevieja</li>
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Golf Resorts</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Las Colinas</li>
                      <li>• Villamartín</li>
                      <li>• La Finca</li>
              ...
              <div className="bg-primary-900 p-8 rounded-sm text-white">
                ...
                <p className="text-warm-300 mb-6">
                  Klar til å starte ditt eiendomssøk? Kontakt oss i dag for en gratis, uforpliktende konsultasjon.
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <p className="text-warm-400 text-sm">
                    Arbeidstider: Mandag - Fredag, 9am - 6pm (CET)
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-primary-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
              Klar til å Finne Din Drømmebolig i Spania?
            </h2>
            <p className="text-warm-300 mb-8 max-w-2xl mx-auto">
              Bla gjennom vår omfattende portefølje av nybygde eiendommer eller kontakt oss for personlig anbefalinger.
            </p>
