...
// Export metadata for Norwegian homepage
export const metadata: Metadata = {
  title: 'Nybygg Costa Blanca | Villaer & Leiligheter i Spania',
  description: 'Finn drømmeboligen din på Costa Blanca, Spania. Nybyggede villaer, leiligheter og rekkehus fra €164.000. Eksperthjælp for norske kjøpere.',
  keywords: 'nybygg Costa Blanca, kjøpe hus Spania, bolig Costa Blanca, villa Costa Blanca, leiligheter Spania',
  openGraph: {
    title: 'Nybygg Costa Blanca | Villaer & Leiligheter i Spania',
    description: 'Finn drømmeboligen din på Costa Blanca. Nybyggede villaer, leiligheter og rekkehus fra pålitlige byggherrer.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Luksusvilla og leiligheter på Costa Blanca, Spania',
      },
    ],
  },
  twitter: {
    ...
    description: 'Finn drømmeboligen din på Costa Blanca, Spania.',
...
// Helper to format price in Norwegian locale
...
export default function NorskHomepage() {
      ...
      <main className="min-h-screen bg-warm-50">
            ...
            <div className="max-w-7xl mx-auto px-6 pb-6 md:pb-10 w-full">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-warm-300 max-w-xl mx-auto">
                  Innflytningsklare boliger fra €164.000. Ditt mediterrane liv begynner her.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Viktige guider for å hjelpe deg å ta velinformerte beslutninger om å kjøpe eiendom i Spania.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    10-års garanti, energieffektivt, ingen megler, moderne design - oppdag fordelene med å kjøpe nytt.
                  </p>
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Nord vs Sør Costa Blanca
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Klima, priser, ekspatsamfunn, flyplasser - hvilket område passer din livsstil bedre?
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Les Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/no/guides/key-ready-vs-off-plan"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Innflyttingsklar vs Fra Tegning
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Flytt inn nå eller spar penger? Sammenlign fordeler, ulemper og betalingsalternativer.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Les Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-14 bg-primary-900">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-4 mb-2">
                ...
                <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                  Oppdag Destinasjoner
                </span>
                <div className="w-10 h-px bg-accent-500" />
              </div>
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Komplette <span className="font-semibold">Boligguider</span>
              </h2>
              <p className="text-warm-300 mt-2 max-w-xl mx-auto text-sm">
                De mest omfattende bydelsguidene på internett — med dronefotografier, eiendomspriser og insider-tips.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    7 bydeler med helikopterdronefotografi. Costa Blanca Sør.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">104+ bilder</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 områder</span>
                  </div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    4 bydeler under Montgóberget. Costa Blanca Nord.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">4 bydeler</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 strander</span>
              ...
              <Link
                href="/no/guides/costa-blanca-north"
                className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all"
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    6 byer sammenlignet med dronefotografi. Fullstendig regionoversikt.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">6 byer</span>
            ...
            <div className="text-center mt-6">
              <Link href="/no/guides" className="text-accent-400 hover:text-accent-300 text-sm font-medium transition-colors">
                Se Alle Guider →
              </Link>
            </div>
          </div>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[450px]">
            ...
            <Link
              href={`/no/properties/${featured.southVilla1.reference}`}
            ...
            <Link
              href={`/no/properties/${featured.southVilla2.reference}`}
              className="group relative h-[350px] md:h-auto overflow-hidden"
            >
              <Image
        ...
        <section className="relative">
          ...
          <div className="bg-warm-800 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Pinoso Villaer fra €518k
              </h2>
              <p className="text-warm-400 mt-2 text-sm">
                Fredelig landsbylivstil med private bassenger, større tomter og eksepsjonell verdi
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            ...
            <Link
              href={`/no/properties/${featured.inland1.reference}`}
            ...
            <Link
              href={`/no/properties/${featured.inland2.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
          ...
          <div className="bg-warm-800 py-4 text-center">
            ...
            >
              Utforsk Alle Landsbyeiendommer
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-warm-600 leading-relaxed mb-5">
                  Vi arbeider direkte med utviklere, inspiserer personlig hver eiendom,
                  og gir helhetsstøtte for internasjonale kjøpere.
                </p>
                <Link
                  href="/no/contact"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Reviderte Utviklere</h3>
                  <p className="text-warm-600 text-xs">Kun bevist track record.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Flerspråklig</h3>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Boliglånhjelp</h3>
                  <p className="text-warm-600 text-xs">Sammenlign spanske banker.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Virtuelle Turer</h3>
                  <p className="text-warm-600 text-xs">Se fra hvor som helst.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[550px]">
            ...
            <div className="relative h-[400px] md:h-auto overflow-hidden bg-success-900">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-12">
                ...
                <h2 className="text-3xl md:text-4xl font-light text-white mb-4 leading-tight">
                  Våkn Til<br />
                  <span className="font-semibold">Golfbanutsikt</span>
                </h2>

                <p className="text-success-100 mb-6 max-w-md leading-relaxed">
                  Bo på mestererskapsbaner ved La Finca, Lo Romero & Vistabella.
                  År rundt sol, innflytningsklare villaer og golf på dørstokken.
                </p>
                ...
                <div className="flex flex-wrap gap-6 mb-6">
                  <div>
                    ...
                    <div className="text-success-200 text-xs uppercase tracking-wide">Golfbaner</div>
                  </div>
                  <div>
                    <div className="text-2xl font-semibold text-white">320</div>
                    <div className="text-success-200 text-xs uppercase tracking-wide">Soldager</div>
                  </div>
                  <div>
            ...
            <Link
              href={`/no/properties/${featured.golf1.reference}`}
          ...
          <div className="grid md:grid-cols-2 h-[350px]">
            {/* Golf Property 2 */}
            <Link
              href={`/no/properties/${featured.golf2.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
            ...
            {/* Golf Property 3 */}
            <Link
              href={`/no/properties/${carousels['south-golf'].properties[2]?.reference || featured.golf1.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-warm-600 mt-1 text-sm">
                  Jávea, Moraira, Calpe — dramatiske kystlinjer og eksklusive eiendommer.
                </p>
              </div>
              <Link
                href="/no/properties?region=costa-blanca-north"
                className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm"
              >
                Utforsk Nord
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Kjøpsprossessen i Spania
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Steg-for-steg guide fra eiendomssøk til avslutning. NIE, advokater, registrering og nøkkeloverdragelse.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Les Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/no/guides/kostnader-skatter"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Kostnader, Skatter & Gebyrer
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Fullstendig nedbryting av kjøpskostnader: IVA, stempel, registreringsgebyrer og løpende utgifter.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Les Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/no/guides/boliglan-spania"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Spanske Boliglån for Utlendinger
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Hvordan få boliglån i Spania. Krav, rentesatser og hvor mye du kan låne.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Les Guide
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-12 bg-warm-100 border-y border-warm-200">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Hva Slags <span className="font-semibold">Kjøper Er Du?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Ulike kjøpere har ulike behov. Finn guider tilpasset din situasjon.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                  Planlegger du å Leie Din Eiendom?
                </h3>
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Lær om turistutleiingslisenser i Valencia. Nye 2025-regler, krav, kostnader og hvordan vi kan hjelpe.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Guide for Turistutleie
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </span>
              ...
              >
                ...
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Usikker hvilken kyst? Sammenlign Alicantes Costa Blanca med Murcias Costa Cálida - priser, klima og livsstil.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Se Sammenlikningen
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="relative">
          ...
          <div className="bg-primary-900 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Luksusvilla fra €800k+
              </h2>
              <p className="text-warm-400 mt-2 text-sm">
                Håndplukket premiumeriendom i Jávea, Moraira & Costa Blanca Nord
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Left Bespoke Villa */}
            <Link
              href={`/no/properties/${featured.bespokeLeft.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
            ...
            {/* Right Bespoke Villa */}
            <Link
              href={`/no/properties/${featured.bespokeRight.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Villa Atlantis */}
            <Link
              href={`/no/developments/${miralboVillas.villaAtlantis.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
            ...
            {/* Villa Posidonia */}
            <Link
              href={`/no/developments/${miralboVillas.villaPosidonia.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
          ...
          <Link
            href={`/no/developments/${miralboVillas.villaMIR0159.slug}`}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 md:right-1/2 p-8">
              ...
              <p className="text-warm-300 text-sm mb-4">{miralboVillas.villaMIR0159.town} — Samtidsmediterransk Bolig</p>
          ...
          <div className="bg-primary-900 py-4 text-center">
            <Link
              href="/no/properties?minPrice=800000"
              className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-400 transition-colors group text-sm"
            >
              Utforsk Full Skreddersydd Samling
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
