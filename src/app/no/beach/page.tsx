...
export const metadata: Metadata = {
  title: 'Strandeiendommer Costa Blanca | Nybygg Nær Stranden',
  description: 'Oppdag nybygg nær Costa Blancas beste strender. Fra strandeiendommer til villaer på gangavstand. La Zenia, Playa Flamenca, Torrevieja-strender.',
  keywords: 'strandeiendommer spania, strandeilighet costa blanca, villa nær strand, la zenia eiendom, playa flamenca leiligheter',
  openGraph: {
    title: 'Strandeiendommer Costa Blanca',
    description: 'Nybyggede eiendommer nær Costa Blancas beste strender. Gangavstand til Middelhavet.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/no/beach',
    languages: {
...
const POPULAR_BEACHES = [
  {
    ...
    town: 'Orihuela Costa',
    description: 'Krystallklart vann og Cala Bosque-bukten. En av de mest populære strendra på Costa Blanca sør.',
    image: '/images/beaches/la-zenia.jpg',
    zones: ['la zenia'],
    amenities: ['Blå flagg', 'Livredder', 'Restauranter', 'Parkering'],
  },
  {
    name: 'Playa Flamenca',
    town: 'Orihuela Costa',
    description: 'Familievennlig strand med rolige vann og utmerkede fasiliteter. Gangavstand til butikker og restauranter.',
    image: '/images/beaches/playa-flamenca.jpg',
    zones: ['playa flamenca', 'aguamarina'],
    amenities: ['Blå flagg', 'Livredder', 'Strandkafeer', 'Strandpromenade'],
  },
  {
    name: 'Playa del Cura',
    town: 'Torrevieja',
    description: 'Sentral Torrevieja-strand med fantastisk utsikt og livlig atmosfære. Nær de berømte saltsøene.',
    image: '/images/beaches/playa-del-cura.jpg',
    zones: ['playa de el cura', 'playa del cura', 'playa el cura'],
    amenities: ['Blå flagg', 'Strandpromenade', 'Restauranter', 'Sentrum'],
  },
  {
    name: 'Playa de La Mata',
    town: 'Torrevieja',
    description: 'Lang sandstrand som strekker seg over 2 km med naturlige sanddyner. Perfekt for tur og vannsport.',
    image: '/images/beaches/la-mata.jpg',
    zones: ['la mata'],
    amenities: ['Naturlige sanddyner', 'Strandkafeer', 'Parkering', 'Idrett'],
  },
  {
    name: 'Cabo Roig',
    town: 'Orihuela Costa',
    description: 'Vakker buktstrand (Cala Capitán) med steinete utspring. Kjent for lørdagsmarkedet.',
    image: '/images/beaches/cabo-roig.jpg',
    zones: ['cabo roig'],
    amenities: ['Buktstrand', 'Marina', 'Restauranter', 'Marked'],
  },
  {
    name: 'Mil Palmeras',
    town: 'Pilar de la Horadada',
    description: 'Fredelig strand med fint sand og klart vann. Mindre folksomt, perfekt for familier.',
    image: '/images/beaches/mil-palmeras.jpg',
    zones: ['mil palmeras'],
    amenities: ['Blå flagg', 'Rolige vann', 'Familievennlig', 'Strandpromenade'],
  },
];

export default async function BeachPropertiesPageNo() {
  ...
  const pageSchema = collectionPageSchema({
    name: 'Strandeiendommer Costa Blanca',
    description: 'Nybyggede eiendommer nær strender i Costa Blanca',
    url: 'https://newbuildhomescostablanca.com/no/beach',
    items: beachDevelopments.slice(0, 20).map(d => ({
      name: d.name,
      url: `https://newbuildhomescostablanca.com/no/developments/${d.slug}`,
      price: d.priceFrom
    }))
  });
  ...
  return (
    <main className="min-h-screen bg-warm-50">
      ...
      <section className="relative h-[50vh] min-h-[400px] max-h-[500px]">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Flyfoto av Costa Blanca-strender med turkis middelhavsvannet"
            fill
          ...
          <div className="max-w-7xl mx-auto px-6 pb-10 w-full">
            ...
            <nav className="mb-4">
              <ol className="flex items-center gap-2 text-sm text-warm-300">
                <li><Link href="/no" className="hover:text-white">Hjem</Link></li>
                <li>/</li>
                <li className="text-white">Strandeiendommer</li>
              </ol>
            </nav>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-3">
              Strandeiendommer <span className="font-semibold">Costa Blanca</span>
            </h1>

            <p className="text-warm-200 text-lg max-w-2xl mb-6">
              {beachDevelopments.length} nybyggingsprosjekter nær Middelhavet beste strender.
              Fra strandeiendommer til villaer på gangavstand.
            </p>
            ...
            <div className="flex flex-wrap gap-6 text-white">
              <div>
                ...
                <div className="text-sm text-warm-300">Strandeiendom</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-accent-400">{walkingDistance.length}</div>
                <div className="text-sm text-warm-300">Gangavstand</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-accent-400">{developmentsByBeach.size}</div>
                <div className="text-sm text-warm-300">Strandlokasjoner</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white border-b border-warm-200 sticky top-[72px] z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-1 overflow-x-auto py-3">
            ...
            >
              Alle Strandeiendommer ({beachDevelopments.length})
            </Link>
            <Link
              href="#beachfront"
            ...
            >
              🌊 Strandeiendom ({beachfront.length})
            </Link>
            <Link
              href="#walking"
              className="px-4 py-2 rounded-sm text-sm font-medium bg-warm-100 text-primary-900 hover:bg-warm-200 transition-colors whitespace-nowrap"
            >
              🚶 Gangavstand ({walkingDistance.length})
            </Link>
            <Link
              href="#nearby"
              className="px-4 py-2 rounded-sm text-sm font-medium bg-warm-100 text-primary-900 hover:bg-warm-200 transition-colors whitespace-nowrap"
            >
              🚗 Kort biltur ({shortDrive.length})
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-light text-primary-900">
              Populære <span className="font-semibold">Strandområder</span>
            </h2>
            <p className="text-warm-600 mt-2">
              Utforsk eiendommer nær Costa Blancas mest ettertraktede strender
            </p>
          </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-warm-200">
                      <div>
                        ...
                        <span className="text-warm-600 text-sm ml-1">eiendommer</span>
                      </div>
                      {minPrice > 0 && (
                        <div className="text-sm">
                          <span className="text-warm-600">Fra </span>
        ...
        <section id="beachfront" className="py-12 bg-warm-50">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Strand <span className="font-semibold">Eiendommer</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Våkn til lyden av bølger. Disse eiendommene ligger rett på stranden.
            </p>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-4 mt-3 pt-3 border-t border-warm-100 text-sm text-warm-600">
                      <span>{dev.bedroomRange} soverom</span>
      ...
      {walkingDistance.length > 0 && (
        <section id="walking" className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
              Gangavstand <span className="font-semibold">til Stranden</span>
            </h2>
            <p className="text-warm-600 mb-8">
              Bare en kort gåtur til sanden. Den perfekte balansen mellom strandtilgang og privatliv.
            </p>
            ...
            {walkingDistance.length > 8 && (
              <div className="text-center mt-8">
                <Link
                  href="/no/developments?beach=walking"
                ...
                >
                  Vis alle {walkingDistance.length} Eiendommer på Gangavstand
      ...
      <section id="all" className="py-12 bg-warm-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-2">
            Alle Strand <span className="font-semibold">Eiendommer</span>
          </h2>
          <p className="text-warm-600 mb-8">
            Bla gjennom alle {beachDevelopments.length} nybyggingsprosjekter nær Costa Blanca strender.
          </p>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2 flex gap-1">
                    ...
                    {dev.status === 'key-ready' && (
                      <span className="bg-accent-500 text-white text-xs px-2 py-0.5 rounded-sm">Klar</span>
                    )}
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                    <div className="text-lg font-semibold text-white">{formatPrice(dev.priceFrom)}</div>
          ...
          {beachDevelopments.length > 16 && (
            <div className="text-center mt-8">
              <Link
                href="/no/developments?tag=beach-lover"
              ...
              >
                Vis alle {beachDevelopments.length} Strandeiendommer
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
      ...
      <section className="py-12 bg-white border-t border-warm-200">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-primary-900 mb-4">
            Strandeiendommer i Costa Blanca, Spania
          </h2>
          <div className="prose prose-warm max-w-none text-warm-700">
            <p>
              Costa Blanca tilbyr noen av Middelhavet finest strender, med over 200 km kystlinje som inneholder
              blåflaggstrender, skjulte bukter og lange sandstrender. Vårt utvalg av nybyggede eiendommer
              plasserer deg innenfor lett rekkevidde av disse fantastiske strendra.
            </p>
            <h3>Populære Strandområder</h3>
            <p>
              <strong>Orihuela Costa</strong> - Hjem for La Zenia, Playa Flamenca og Cabo Roig, dette området
              tilbyr en perfekt blanding av strandliv og moderne fasiliteter. Eiendommer her spenner fra
              leiligheter til luksusvillauet, mange innenfor gangavstand til stranden.
            </p>
            <p>
              <strong>Torrevieja</strong> - En livlig kystby med flere strender inkludert Playa del
              Cura og La Mata. De berømte saltsøene skaper ett unikt mikroklima, og byen tilbyr
              utmerket infrastruktur for året rundt.
            </p>
            <p>
              <strong>Pilar de la Horadada</strong> - På den sørlige spissen av Costa Blanca, strender som
              Mil Palmeras tilbyr et mer rolig miljø med klart vann.
            </p>
          </div>
        </div>
      </section>
