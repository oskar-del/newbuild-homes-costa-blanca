...
export const metadata: Metadata = {
  title: 'Innlands Eiendommer Costa Blanca | Nye Boliger Innlandet',
  description: 'Oppdag nye boligprosjekter i innlandet Costa Blanca og Costa Calida. Mer plass, bedre verdi og autentisk spansk livin g i byer som Algorfa, Rojales, Polop og mer.',
  openGraph: {
    title: 'Innlands Eiendommer Costa Blanca',
    description: 'Nye hus innlandet Costa Blanca. Mer plass, bedre verdi, autentisk Spania.',
    type: 'website',
  },
  alternates: {
...
export default async function InlandPropertiesPage() {
  ...
  const breadcrumbs = breadcrumbSchema([
    { name: 'Hjem', url: 'https://newbuildhomescostablanca.com/' },
    { name: 'Innlands eiendommer', url: 'https://newbuildhomescostablanca.com/no/inland/' },
  ]);
        ...
        <section className="relative bg-primary-900 py-16 md:py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <nav className="text-warm-400 text-sm mb-6">
              ...
              <span className="text-white">Innlands eiendommer</span>
            </nav>
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                  Mer plass • Bedre verdi
                </span>
              </div>

              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
                Nye bygninger <span className="font-semibold">innlandet</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Oppdag hjertet av Spania med vår utvalg av nybygg innlandet Costa Blanca.
                Nyt større tomter, tradisjonelle landsbyer, golfbaner og priser opp til 40% lavere enn kyststedene
                - alt bare 20-30 minutter fra strendene.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div>
                  ...
                  <div className="text-warm-400 text-sm">Gjennomsnittspris</div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-3">
                Hvorfor kjøpe <span className="font-semibold">innlandet?</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Mange kjøpere oppdager at innlandet Costa Blanca gir utmerket verdi og et mer autentisk spansk liv.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <p className="text-warm-600 text-sm">Eiendommer kan være 30-40% billigere enn kystlikt med samme bygningskvalitet.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Mer plass</h3>
                <p className="text-warm-600 text-sm">Større tomter og hager. Mange eiendommer har 500m²+ tomter mot 100-200m² ved kysten.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Autentisk Spania</h3>
                <p className="text-warm-600 text-sm">Tradisjonelle landsbyer, lokale markeder og spansk kultur. Mindre turistisk, mer autentisk.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Nær kysten</h3>
                <p className="text-warm-600 text-sm">De fleste innlandsbyene er bare 20-30 minutter fra stranden. Best av begge verdener!</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{southInland.length} eiendommer tilgjengelig</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Blanca <span className="font-semibold">Sør innlandet</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Vega Baja-regionen gir best kvalitet for pengene i Costa Blanca. Byer som Algorfa, Rojales og San Miguel de Salinas kombinerer utmerkede golfbaner, tradisjonelle spanske markeder og lett strandtilgang - alt til priser 30-40% under kysten.
                  </p>
                </div>
              </div>
              ...
              {southInland.length > 6 && (
                <div className="text-center mt-8">
                  ...
                  >
                    Se alle {southInland.length} sør innlands eiendommer
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{northInland.length} eiendommer</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Blanca <span className="font-semibold">Nord innlandet</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Flykt til den fantastiske Jalon Valley vinregionen, den sjarmerende fjellbyen Polop, eller det pulserende La Nucia. Nord tilbyr dramatisk landskap, kjølere somrer og et mer etablert utlendingsamfunn - perfekt for de som søker en fredelig livsstil.
                  </p>
                </div>
              </div>
              ...
              {northInland.length > 6 && (
                <div className="text-center mt-8">
                  ...
                  >
                    Se alle {northInland.length} nord innlands eiendommer
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{costaCalidaInland.length} eiendommer</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Calida <span className="font-semibold">innlandet</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Murcia-regionen gir ekseptionell verdi med mer spansk stemning. Byer som Torre Pacheco og Fuente Álamo gir autentisk landlig liv med lett tilgang til Mar Menor-strender og Murcia-byen.
                  </p>
                </div>
              </div>
              ...
              {costaCalidaInland.length > 6 && (
                <div className="text-center mt-8">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors"
                  >
                    Se alle {costaCalidaInland.length} Costa Calida innlands eiendommer
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Alle <span className="font-semibold">innlands eiendommer</span>
                  </h2>
                  <p className="text-warm-600 mt-1">
                    Bla gjennom alle {properties.length} innlands nybygg
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-3">
                Populære innlandsbyer
              </h2>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: 'Algorfa', region: 'Sør', golf: true },
                { name: 'Rojales', region: 'Sør', golf: true },
                { name: 'San Miguel de Salinas', region: 'Sør' },
                { name: 'Benijofar', region: 'Sør' },
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {area.mountain && <span className="text-xs bg-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded">Fjell</span>}
        ...
        <section className="py-16 bg-warm-50">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
              Vil du utforske innlands alternativer?
            </h2>
            <p className="text-warm-600 leading-relaxed mb-8 max-w-2xl mx-auto">
              Vårt team kan arrangere visninger av innlands eiendommer og hjelpe deg forstå fordelene med hver område.
              Vi viser deg lokale fasiliteter, kjøreavstander til kysten og hjelper deg finne den perfekte balansen.
            </p>
