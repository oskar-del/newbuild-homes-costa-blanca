...
export const metadata: Metadata = {
  title: 'Costa Blanca Områder | Bolig- og Eiendomsveiledninger',
  description: 'Oppdag de beste områdene for å bo på Costa Blanca. Omfattende veiledninger til Jávea, Moraira og mer med eiendomslister og livsstilsinformasjon.',
  openGraph: {
    title: 'Costa Blanca Områder | Bolig- og Eiendomsveiledninger',
    description: 'Oppdag de beste områdene for å bo på Costa Blanca. Utforsk Jávea, Moraira, Calpe og andre premium-lokasjoner.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Costa Blanca Områder | Bolig- og Eiendomsveiledninger',
    description: 'Oppdag de beste områdene for å bo på Costa Blanca. Omfattende veiledninger til toppsteder.',
  },
  alternates: {
    ...
    <main className="min-h-screen bg-warm-50">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                Finn din ideelle beliggenhet
              </span>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
              Costa Blanca <span className="font-semibold">Områder</span>
            </h1>

            <p className="text-warm-300 text-lg leading-relaxed mb-8">
              Fra den rimelige solrike sørkysten til den prestisjeløse nordkysten.
              Utforsk våre detaljerte veiledninger for å finne ditt perfekte hjørne av Costa Blanca.
            </p>
            ...
            <div className="flex flex-wrap gap-8">
              ...
              <div>
                ...
                <div className="text-warm-400 text-sm">Soldager</div>
              </div>
              <div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-warm-500 text-xs">Snittpris</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-accent-400 text-sm font-medium">Beste verdi i Spania</p>
                </div>
                <div className="text-right">
                  <div className="text-lg font-semibold text-white">€179,000</div>
                  <div className="text-warm-400 text-xs">Snittpris</div>
                </div>
              </div>
              <p className="text-warm-300 text-sm mb-4 line-clamp-2">
                Murcias Mar Menor-region. Championship-golf, året rundt solskinn, 25-40% rimeligere enn Costa Blanca.
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-xs">Soldager</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-semibold text-white">{southData.stats.golfCourses}</div>
                  <div className="text-warm-400 text-xs">Golfbaner</div>
                </div>
                <div className="text-center">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <div className="text-lg font-semibold text-white">
                            Fra €{area.priceRange.min.toLocaleString()}
                          </div>
                        </div>
                      </div>
                    )}
                    <div className="p-4 bg-primary-900">
                      ...
                      <div className="mt-3 flex items-center justify-between text-sm">
                        {area.propertyCount > 0 && (
                          <span className="text-warm-500">{area.propertyCount} eiendommer</span>
                        )}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {southData.popularTowns.map(town => (
                  <div key={town} className="bg-white p-4 rounded-sm border border-warm-200">
                    ...
                    <p className="text-sm text-warm-500">Områdeguide kommer snart</p>
                  </div>
                ))}
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-xs">Michelin-restauranter</div>
                </div>
                <div className="text-center">
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-primary-900 font-medium text-lg">Vil du utforske prosjekter i disse områdene?</p>
            <p className="text-warm-500 text-sm mt-1">Kontakt oss for seneste tilgjengelighet, planløsninger eller for å bestille visning</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                Usikker på hvilket område som passer?
              </h2>
              <p className="text-warm-300 leading-relaxed mb-6">
                Med så mange fantastiske steder å velge mellom, kan det være overvelmende.
                Fortell oss dine prioriteringer—budsjett, livsstil, nærhet til strand eller golf—og
                vi anbefaler det perfekte området for deg.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-5 rounded-sm">
                ...
                <div className="text-warm-300 text-sm">Års lokal kunnskap</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">500+</div>
                <div className="text-warm-300 text-sm">Familier hjulpet</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">Free</div>
                <div className="text-warm-300 text-sm">Gratis konsultasjon</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
