              ...
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <p className="text-warm-600 leading-relaxed">
                    ...
                    Perfect for buyers who want to start their Mediterranean lifestyle immediately—whether that's
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <p className="text-warm-600 leading-relaxed">
                    ...
                    with stunning panoramic views. Terra Mítica theme park and Puig Campana hiking trails
              ...
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <p className="text-warm-600 leading-relaxed mb-4">
                    ...
                    charming marinas, and a sophisticated lifestyle. Famous for the iconic Peñón de Ifach,
                    crystal-clear coves, and award-winning restaurants.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                    <span className="bg-warm-100 px-3 py-1 rounded-full text-sm text-warm-700">Jávea Old Town</span>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <p className="text-warm-600 leading-relaxed mb-4">
                    Just south of Costa Blanca lies the Costa Calida—Murcia's stunning coastline featuring
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <p className="text-warm-600 leading-relaxed">
                    Get in early on these recently launched developments. Off-plan purchases offer the best prices—
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-light text-white mb-4">
                  Looking to Find Your Perfect Development?
                </h2>
                <p className="text-warm-200 text-lg leading-relaxed mb-6">
                  Our agents specialize in new build properties on the Costa Blanca — with 12+ years of experience, we'll help you find your perfect home.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/consultation"
                    className="bg-accent-500 hover:bg-accent-600 text-white font-medium px-6 py-3 rounded-lg transition-colors inline-flex items-center gap-2"
                  >
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-semibold text-sm">Expert Market Knowledge</h4>
                        <p className="text-warm-300 text-xs mt-1">12+ years in Costa Blanca new build market</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-accent-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        <h4 className="text-white font-semibold text-sm">Personalized Matches</h4>
                        <p className="text-warm-300 text-xs mt-1">Find properties matching your budget and needs</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-accent-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        <h4 className="text-white font-semibold text-sm">No Buyer Fees</h4>
                        <p className="text-warm-300 text-xs mt-1">We work with developers and builders directly</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-accent-500">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              ...
              Tell us your requirements—budget, location, move-in date—and we'll match you with the perfect projects.
            </p>
