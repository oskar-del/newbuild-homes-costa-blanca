        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              {/* ============================================================ */}
              {(() => {
                const videos = getVideosForDevelopment(data.slug);
                if (videos.length === 0) return null;

                return (
                  <section className="bg-primary-900 rounded-xl p-8 md:p-12 shadow-lg">
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-warm-50">
        ...
        {/* Video Tour */}
        {(() => {
          const videos = getVideosForDevelopment(development.slug);
          if (videos.length === 0) return null;
          return (
            <section className="max-w-7xl mx-auto px-6 pt-12">
              <div className="bg-primary-900 rounded-xl p-8 md:p-12">
                <div className="flex items-center justify-center gap-4 mb-6">
                  <div className="w-10 h-px bg-accent-500" />
                  <span className="text-accent-500 text-xs font-medium tracking-widest uppercase">Video Tour</span>
                  <div className="w-10 h-px bg-accent-500" />
                </div>
                <h2 className="text-2xl md:text-3xl font-light text-white text-center mb-8">
                  {development.name} Video Tour
                </h2>
