          ...
          <div className="max-w-4xl mx-auto">
            ...
            {structured?.quickAnswer && (
              <div className="bg-accent-500/10 border-l-4 border-accent-500 p-6 rounded-sm mb-8">
                <p className="font-semibold text-primary-900 mb-2">Kort antwoord</p>
            ...
            {structured?.sections && structured.sections.length > 2 && (
              <nav className="bg-white border border-warm-200 rounded-sm p-6 mb-8">
                <p className="font-semibold text-primary-900 mb-3">Inhoudsopgave</p>
            ...
            {structured?.conclusion && (
              <section className="mb-10">
                <h2 className="text-2xl sm:text-3xl font-light text-primary-900 mb-4">Conclusie</h2>
            ...
            {structured?.faqs && structured.faqs.length > 0 && (
              <section className="mb-10">
                <h2 className="text-2xl sm:text-3xl font-light text-primary-900 mb-6">Veelgestelde vragen</h2>
            ...
            <div className="bg-gradient-to-r from-primary-900 to-primary-800 rounded-sm p-8 text-white text-center mb-10">
              <h3 className="text-2xl font-light mb-4">Heeft u vragen?</h3>
              <p className="text-warm-200 mb-6">Ons Nederlandstalig team in Spanje helpt u graag verder</p>
            ...
            {relatedArticles.length > 0 && (
              <section>
                <h2 className="text-2xl font-light text-primary-900 mb-6">Meer artikelen</h2>
