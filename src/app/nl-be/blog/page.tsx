...
export const metadata: Metadata = {
  title: 'Costa Blanca Gidsen: Kopen, Wonen & Lifestyle | Belgische Tips',
  description: 'Uw gidsen voor mediterraan leven. Gebiedsgidsen, strandgidsen, kooptips, golfverhalen en alles wat u moet weten over leven op Costa Blanca voor Belgische kopers.',
  openGraph: {
    title: 'Costa Blanca Gidsen: Kopen, Wonen & Lifestyle',
    description: 'Uw gids naar mediterraan leven in Spanje.',
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl-be/blog',
  },
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/nl-be/blog',
    languages: {
...
const CATEGORIES: Record<string, CategoryConfig> = {
  ...
  areas: {
    ...
    description: 'Noord vs zuid, strand vs binnenland - vind uw perfecte plek',
    ...
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between mb-8">
          ...
          {articles.length > 3 && (
            <Link
              href={`/nl-be/blog?category=${category}`}
...
export default function BlogPageBelgian(): JSX.Element {
  ...
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'Blog', url: 'https://newbuildhomescostablanca.com/nl-be/blog/' },
  ]);
  ...
  const blogCollectionSchema = collectionPageSchema({
    ...
    items: articles.slice(0, 10).map((a: Article) => ({
      name: a.title,
      url: `https://newbuildhomescostablanca.com/nl-be/blog/${a.slug}/`,
    })),
  });
        ...
        <section className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 py-12 md:py-20">
          <div className="max-w-7xl mx-auto px-6">
            <nav className="text-warm-400 text-sm mb-8">
              <Link href="/nl-be" className="hover:text-white transition-colors">
                Home
              </Link>
            ...
            <div className="grid lg:grid-cols-5 gap-8 items-start">
              <div className="lg:col-span-2">
                ...
                <p className="text-warm-200 text-lg leading-relaxed mb-8">
                  Alles wat u moet weten over het kopen van onroerend goed en wonen op Spaanse zonnigste kust.
                </p>
        ...
        <section className="py-16 bg-gradient-to-r from-accent-500 to-accent-600">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-white/90 mb-8 max-w-xl mx-auto">
              Ontvang nieuwe artikelen, vastgoedmarktupdate en insider tips wekelijks in uw inbox.
            </p>
            <form
              className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto"
              name="newsletter-nl-be"
              method="POST"
              data-netlify="true"
            >
              <input
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-white/90 mb-4">
                  Ons lokale team beantwoordt graag uw vragen.
                </p>
