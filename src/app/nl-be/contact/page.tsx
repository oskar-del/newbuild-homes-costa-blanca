...
export const metadata: Metadata = {
  ...
  description: 'Neem contact op met New Build Homes Costa Blanca. Deskundige begeleiding voor het kopen van nieuwbouw in Spanje. WhatsApp, telefoon, e-mail of contactformulier. Wij spreken Vlaams!',
  openGraph: {
    title: 'Contact | New Build Homes Costa Blanca',
    ...
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl-be/contact',
  ...
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/nl-be/contact',
    languages: {
...
export default function BEContactPage() {
  const businessSchema = localBusinessSchema();
  const breadcrumbs = breadcrumbSchema([
    { name: 'Home', url: 'https://newbuildhomescostablanca.com/nl-be/' },
    { name: 'Contact', url: 'https://newbuildhomescostablanca.com/nl-be/contact/' },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-warm-600 max-w-2xl mx-auto">
            Klaar om je droomhuis op Costa Blanca te vinden? We zijn hier om je met deskundige begeleiding door elke stap te begeleiden. Wij spreken Vlaams!
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <h3 className="font-semibold text-primary-900 mb-2">Vlaams Service</h3>
                <p className="text-sm text-warm-600">
                  Wij spreken vloeiend Vlaams en kunnen je door het hele koopproces in je eigen taal begeleiden.
                </p>
              </div>
            </div>
          </div>
