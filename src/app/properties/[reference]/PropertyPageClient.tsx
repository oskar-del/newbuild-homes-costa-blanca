...
const BRAND_ORANGE_DARK = '#d4792c';
...
function PriceGrowthChart({ data }: { data: { year: string; price: number }[] }) {
  ...
  return (
    <div className="mt-6">
      <h4 className="font-semibold text-stone-800 mb-4">Costa Blanca Price Growth (€/m²)</h4>
      <div className="space-y-3">
        {data.map((item) => (
          <div key={item.year} className="flex items-center gap-3">
            <span className="w-12 text-sm text-stone-600">{item.year}</span>
...
function RentalYieldChart({ data }: { data: { area: string; yield: number; color: string }[] }) {
  ...
  return (
    <div className="mt-6">
      <h4 className="font-semibold text-stone-800 mb-4">Rental Yield by Area (%)</h4>
      <div className="space-y-3">
        {data.map((item) => (
          <div key={item.area} className="flex items-center gap-3">
            <span className="w-28 text-sm text-stone-600 truncate">{item.area}</span>
            <div className="flex-1 bg-stone-200 rounded-full h-6 overflow-hidden">
              <div
...
function FAQItem({ question, answer, isOpen, onClick }: { 
  ...
  return (
    <div className="border-b border-stone-200 last:border-0">
      <button
        onClick={onClick}
        className="w-full py-4 flex items-center justify-between text-left hover:text-amber-700 transition-colors"
      >
        <span className="font-medium text-stone-800 pr-4">{question}</span>
        <svg
          className={`w-5 h-5 text-amber-600 transition-transform flex-shrink-0 ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
  ...
  return (
    ...
    >
      <div className="relative h-48">
        ...
        />
        {property.price && (
          <div className="absolute bottom-3 left-3 bg-stone-900/90 text-white px-3 py-1 rounded-lg text-sm font-semibold">
    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-stone-500 mb-6">
          ...
          <span>›</span>
          <span className="text-stone-700">{property.reference || property.id}</span>
        </nav>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="absolute bottom-4 right-4 bg-stone-900/80 text-white px-3 py-1 rounded-lg text-sm">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 text-stone-600 mb-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2 text-sm text-stone-500">
                ...
                <span className="text-emerald-600">• Price verified</span>
              </div>
              
              {/* Share Buttons */}
              <div className="flex items-center gap-2">
                <span className="text-sm text-stone-500 hidden sm:inline">Share:</span>
                <a
                ...
                <button
                  ...
                  className="w-8 h-8 bg-stone-200 hover:bg-stone-300 rounded-full flex items-center justify-center transition-colors"
                  title="Copy link"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl p-4 text-center shadow-sm">
                <div className="text-2xl font-bold text-stone-800">{property.bedrooms || 0}</div>
                <div className="text-sm text-stone-500">Bedrooms</div>
              </div>
              <div className="bg-white rounded-xl p-4 text-center shadow-sm">
                <div className="text-2xl font-bold text-stone-800">{property.bathrooms || 0}</div>
                <div className="text-sm text-stone-500">Bathrooms</div>
              </div>
              <div className="bg-white rounded-xl p-4 text-center shadow-sm">
                <div className="text-2xl font-bold text-stone-800">{property.builtArea || 0}</div>
                <div className="text-sm text-stone-500">m² Built</div>
              </div>
              <div className="bg-white rounded-xl p-4 text-center shadow-sm">
                <div className="text-2xl font-bold text-stone-800">{property.plotArea || 0}</div>
                <div className="text-sm text-stone-500">m² Plot</div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {property.hasGarden && (
                <span className="bg-lime-100 text-lime-700 px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                  Garden
                </span>
              )}
              ...
              {property.hasParking && (
                <span className="bg-stone-100 text-stone-700 px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                  Parking
                </span>
              )}
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Beach</div>
                        <div className="text-sm text-stone-500">{amenities.beach} km</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Supermarket</div>
                        <div className="text-sm text-stone-500">{amenities.supermarket} km</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Hospital</div>
                        <div className="text-sm text-stone-500">{amenities.hospital} km</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-amber-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Schools</div>
                        <div className="text-sm text-stone-500">{amenities.school} km</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-lime-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Golf Course</div>
                        <div className="text-sm text-stone-500">{amenities.golf} km</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-stone-800">Airport</div>
                        <div className="text-sm text-stone-500">{amenities.airport} km</div>
                      </div>
                    </div>
                  </div>
            ...
            {/* ==================== AREA SECTION ==================== */}
            {content.areaSection && (
              <div className="bg-gradient-to-br from-sky-50 to-stone-100 border border-sky-200 rounded-xl p-6">
                <h2 className="text-xl font-bold text-stone-800 mb-4 flex items-center gap-2">
                ...
                {property.town && (
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 mt-4 text-sky-600 hover:text-sky-700 font-medium transition-colors"
                  >
            ...
            {/* ==================== LIFESTYLE SECTION ==================== */}
            <div className="bg-gradient-to-br from-amber-50 to-stone-100 border border-amber-200 rounded-xl p-6">
              <h2 className="text-xl font-bold text-stone-800 mb-4 flex items-center gap-2">
            ...
            {/* ==================== INVESTMENT SECTION ==================== */}
            <div className="bg-gradient-to-br from-emerald-50 to-stone-100 border border-emerald-200 rounded-xl p-6">
              <h2 className="text-xl font-bold text-stone-800 mb-4 flex items-center gap-2">
              ...
              <div className="bg-white/70 rounded-lg p-4 mb-6">
                <h4 className="font-semibold text-stone-800 mb-3">Estimated Rental Income</h4>
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-xl font-bold text-emerald-600">
                      {formatPrice(content.rentalIncomeEstimate.annual)}
                    </div>
                    <div className="text-sm text-stone-500">Annual</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-emerald-600">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-stone-500">Weekly (peak)</div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-slate-100 border border-blue-200 rounded-xl p-6">
              <h2 className="text-xl font-bold text-stone-800 mb-4 flex items-center gap-2">
            ...
            {/* ==================== HELPFUL RESOURCES ==================== */}
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h2 className="text-xl font-bold text-stone-800 mb-4">Helpful Resources</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <Link href="/guides/buying-process" className="flex items-center gap-3 p-3 rounded-lg hover:bg-stone-50 transition-colors group">
                  ...
                  <div>
                    <div className="font-medium text-stone-800">Buying Process Guide</div>
                    <div className="text-sm text-stone-500">Step-by-step guide for foreign buyers</div>
                  </div>
                </Link>
                
                <Link href="/guides/nie-number" className="flex items-center gap-3 p-3 rounded-lg hover:bg-stone-50 transition-colors group">
                  <div className="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center group-hover:bg-amber-200 transition-colors">
                    <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="font-medium text-stone-800">NIE Number Guide</div>
                    <div className="text-sm text-stone-500">How to get your Spanish tax ID</div>
                  </div>
                </Link>
                
                <Link href="/guides/mortgages" className="flex items-center gap-3 p-3 rounded-lg hover:bg-stone-50 transition-colors group">
                  <div className="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center group-hover:bg-amber-200 transition-colors">
                    <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="font-medium text-stone-800">Mortgage Guide</div>
                    <div className="text-sm text-stone-500">Financing options for non-residents</div>
                  </div>
                </Link>
                
                <Link href={`/areas/${townSlug}`} className="flex items-center gap-3 p-3 rounded-lg hover:bg-stone-50 transition-colors group">
                  <div className="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center group-hover:bg-amber-200 transition-colors">
                    <svg className="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  ...
                  <div>
                    <div className="font-medium text-stone-800">Area Guide: {property.town || 'Costa Blanca'}</div>
                    <div className="text-sm text-stone-500">Discover the local lifestyle</div>
                  </div>
                </Link>
              </div>
            </div>
            ...
            {/* ==================== BOTTOM CTA ==================== */}
            <div className="bg-gradient-to-br from-amber-50 via-stone-100 to-amber-100 rounded-xl p-6 border border-amber-200">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-stone-800">This Won't Last Long</h3>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href={PHONE_TEL}
                  className="bg-stone-700 hover:bg-stone-800 text-white px-5 py-2.5 rounded-lg font-medium transition-colors flex items-center gap-2"
                >
            ...
            {similarProperties.length > 0 && (
              <div>
                <h2 className="text-xl font-bold text-stone-800 mb-4">Similar Properties</h2>
            ...
            <div className="text-center">
              <Link
                href="/properties"
                className="inline-flex items-center gap-2 bg-stone-800 hover:bg-stone-900 text-white px-8 py-4 rounded-xl font-semibold transition-colors"
              >
                View All Properties
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-stone-800">Oskar Peterson</h4>
                    <p className="text-sm text-stone-500">Property Specialist</p>
                    <div className="flex items-center gap-1 mt-0.5">
                      ...
                      <span className="text-xs text-stone-400 ml-1">(50+ reviews)</span>
                    </div>
                  </div>
                </div>
              ...
              {/* Video Tour CTA */}
              <div className="rounded-xl p-5 shadow-sm" style={{ backgroundColor: BRAND_NAVY }}>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full text-white py-2 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                  style={{ backgroundColor: BRAND_ORANGE }}
                  onMouseOver={(e) => e.currentTarget.style.backgroundColor = BRAND_ORANGE_DARK}
              ...
              {/* Contact Card */}
              <div id="lead-form-section" className="bg-gradient-to-br from-amber-50 to-stone-100 rounded-xl p-5 shadow-sm">
                {property.price && (
                  <div className="text-center mb-4 pb-4 border-b border-stone-200">
                    <div className="text-3xl font-bold text-stone-900">
                      {formatPrice(property.price)}
                    </div>
                    <p className="text-sm text-stone-500">Guide price</p>
                  </div>
                )}
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <a
                    href={PHONE_TEL}
                    className="w-full bg-stone-700 hover:bg-stone-800 text-white py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                ...
                {formSubmitted ? (
                  <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-emerald-800 font-medium">Thank you!</p>
                    <p className="text-sm text-emerald-600">We'll be in touch within 24 hours.</p>
                  </div>
                ) : (
                  <form onSubmit={handleFormSubmit} className="space-y-3">
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 rounded-lg border border-stone-300 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 outline-none transition-colors"
                    />
                    <input
                      type="email"
                      name="email"
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={3}
                      className="w-full px-4 py-2 rounded-lg border border-stone-300 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 outline-none transition-colors resize-none"
                    />
                    <button
                      type="submit"
              ...
              {/* Mortgage CTA */}
              <div className="bg-gradient-to-br from-emerald-50 to-stone-100 border border-emerald-200 rounded-xl p-5">
                <h4 className="font-bold text-stone-800 mb-2">Need Financing?</h4>
              ...
              <div className="bg-stone-800 text-white rounded-xl p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-400">See the property from anywhere</p>
                  </div>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-amber-500 hover:bg-amber-600 text-white py-2.5 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  Schedule Video Call
                </a>
              </div>
              ...
              {/* Floorplan Box */}
              <div className="bg-gradient-to-br from-stone-100 to-stone-200 rounded-xl p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-stone-800">Request Floor Plans</h4>
                    <p className="text-xs text-stone-500">Get detailed layouts</p>
                  </div>
                </div>
                <p className="text-sm text-stone-600 mb-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-stone-700 hover:bg-stone-800 text-white py-2.5 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  Request Floor Plans
                </a>
              </div>
