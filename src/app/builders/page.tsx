...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      'sv': 'https://newbuildhomescostablanca.com/sv/builders',
      'nl': 'https://newbuildhomescostablanca.com/nl/builders',
      'nl-BE': 'https://newbuildhomescostablanca.com/nl-be/builders',
      'fr': 'https://newbuildhomescostablanca.com/fr/builders',
      'no': 'https://newbuildhomescostablanca.com/no/builders',
      'de': 'https://newbuildhomescostablanca.com/de/builders',
      'pl': 'https://newbuildhomescostablanca.com/pl/builders',
      'ru': 'https://newbuildhomescostablanca.com/ru/builders',
