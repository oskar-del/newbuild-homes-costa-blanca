...
export const metadata: Metadata = {
  title: 'Regiony Costa Blanca | Przewodniki po Nieruchomościach i Życiu',
  description: 'Odkryj najlepsze regiony do życia na Costa Blanca. Kompleksowe przewodniki do Jávea, Morairy i wielu innych z listami nieruchomości i informacjami o stylu życia.',
  openGraph: {
    title: 'Regiony Costa Blanca | Przewodniki po Nieruchomościach i Życiu',
    description: 'Odkryj najlepsze regiony do życia na Costa Blanca. Poznaj Jávea, Moairę, Calpe i inne premium lokalizacje.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Regiony Costa Blanca | Przewodniki po Nieruchomościach i Życiu',
    description: 'Odkryj najlepsze regiony do życia na Costa Blanca. Kompleksowe przewodniki do najlepszych lokalizacji.',
  },
  alternates: {
    ...
    <main className="min-h-screen bg-warm-50">
      ...
      <section className="relative bg-primary-900 py-16 md:py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <nav className="text-warm-400 text-sm mb-6">
            ...
            <span className="text-white">Regiony</span>
          </nav>
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                Znajdź idealną lokalizację
              </span>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
              Costa Blanca <span className="font-semibold">Regiony</span>
            </h1>

            <p className="text-warm-300 text-lg leading-relaxed mb-8">
              Od słonecznego, przystępnego południa po prestiżowe północne wybrzeże.
              Poznaj nasze szczegółowe przewodniki, aby znaleźć idealne miejsce na Costa Blanca.
            </p>
            ...
            <div className="flex flex-wrap gap-8">
              <div>
                ...
                <div className="text-warm-400 text-sm">Przewodniki regionów</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-white">320+</div>
                <div className="text-warm-400 text-sm">Słonecznych dni</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-white">50+ km</div>
                <div className="text-warm-400 text-sm">Plaż</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-warm-500 text-xs">Śr. cena</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-accent-400 text-sm font-medium">Najlepsza wartość w Hiszpanii</p>
                </div>
                <div className="text-right">
                  <div className="text-lg font-semibold text-white">€179,000</div>
                  <div className="text-warm-400 text-xs">Śr. cena</div>
                </div>
              </div>
              <p className="text-warm-300 text-sm mb-4 line-clamp-2">
                Region Mar Menor w Murcji. Pola golfowe na poziomie mistrzostw, słońce przez cały rok, 25-40% taniej niż Costa Blanca.
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-xs">Słonecznych dni</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-semibold text-white">{southData.stats.golfCourses}</div>
                  <div className="text-warm-400 text-xs">Pola golfowe</div>
                </div>
                <div className="text-center">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <div className="text-lg font-semibold text-white">
                            Od €{area.priceRange.min.toLocaleString()}
                          </div>
                        </div>
                      </div>
                    )}
                    <div className="p-4 bg-primary-900">
                      ...
                      <div className="mt-3 flex items-center justify-between text-sm">
                        {area.propertyCount > 0 && (
                          <span className="text-warm-500">{area.propertyCount} nieruchomości</span>
                        )}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {southData.popularTowns.map(town => (
                  <div key={town} className="bg-white p-4 rounded-sm border border-warm-200">
                    ...
                    <p className="text-sm text-warm-500">Przewodnik regionu wkrótce</p>
                  </div>
                ))}
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-xs">Restauracje Michelin</div>
                </div>
                <div className="text-center">
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-primary-900 font-medium text-lg">Chcesz poznać projekty w tych regionach?</p>
            <p className="text-warm-500 text-sm mt-1">Skontaktuj się z nami, aby uzyskać najnowsze informacje o dostępności, plany pięter lub zarezerwować wizytę</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                Nie wiesz, który region wybrać?
              </h2>
              <p className="text-warm-300 leading-relaxed mb-6">
                Mając tyle wspaniałych miejsc do wyboru, może być przytłaczające.
                Powiedz nam swoje priorytety—budżet, styl życia, bliskość plaży lub golfu—a
                my rekomendujemy idealny region dla Ciebie.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-5 rounded-sm">
                ...
                <div className="text-warm-300 text-sm">Lat doświadczenia</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">500+</div>
                <div className="text-warm-300 text-sm">Rodzin obsłużonych</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">Free</div>
                <div className="text-warm-300 text-sm">Bezpłatna konsultacja</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">5</div>
                <div className="text-warm-300 text-sm">Języków</div>
              </div>
            </div>
          </div>
        </div>
