...
export const metadata: Metadata = {
  ...
  description: 'Twój zaufany partner dla nowych domów na Costa Blanca i Costa Calida. Fachowe wskazówki dla polskich kupujących szukających swojego wymarzonego domu w Hiszpanii.',
  openGraph: {
    title: 'O Nas | Nowe Domy Costa Blanca',
    description: 'Twój zaufany partner dla nowych domów na Costa Blanca.',
    type: 'website',
  ...
  twitter: {
    card: 'summary',
    title: 'O Nas | Nowe Domy Costa Blanca',
    description: '15+ lat pomagania międzynarodowym kupującym znaleźć swój wymarzony dom w Hiszpanii. Pełny wybór nowych budynków.',
  },
  alternates: {
...
export default function PLAboutPage() {
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'O Nas', url: 'https://newbuildhomescostablanca.com/pl/about/' },
  ]);
        ...
        <section className="relative bg-primary-900 py-20 md:py-28">
          <div className="absolute inset-0 opacity-20">
            <Image
              ...
              alt="Linia brzegowa Costa Blanca"
              fill
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6">
                Twój Partner w Znalezieniu Idealnego <span className="font-semibold">Nowego Domu</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Specjalizujemy się wyłącznie w nowych domach na Costa Blanca i Costa Calida.
                Nasza głęboka znajomość rynku lokalnego, zaufane relacje z deweloperami i zaangażowanie
                w spersonalizowaną obsługę sprawiają, że jesteśmy najlepszym wyborem dla międzynarodowych kupujących szukających swojego
                wymarzonego domu w słonecznej Hiszpanii.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-light text-primary-900 mb-6">
                  Dostęp do <span className="font-semibold">Wszystkich Nowych Domów</span>
                </h2>
                <div className="space-y-4 text-warm-700 leading-relaxed">
                  <p>
                    Zapewniamy dostęp do <strong>pełnego wyboru nowych domów</strong> na Costa Blanca i Costa Calida.
                    Jeśli buduje się to w regionie, możemy ci to pokazać.
                  </p>
                  <p>
                    Przez 15+ lat wybudowaliśmy relacje z każdym głównym deweloperem w regionie.
                    To oznacza, że widzisz wszystko - od butikowych projektów willi po duże inwestycje uzdrowiskowe - wszystko w jednym miejscu.
                  </p>
                  <p>
                    Ale robimy coś więcej niż tylko szukanie nieruchomości. Zgromadziliśmy sieć zaufanych profesjonalistów wspierających twoją całą podróż:
                    <strong> budowniczych, architektów, projektantów wnętrz, prawników, doradców podatkowych i specjalistów hipotecznych</strong>.
                    Kompletny pakiet do zakupu domu w Hiszpanii.
                  </p>
                </div>
              </div>
              <div className="relative">
                <div className="aspect-[4/3] rounded-sm overflow-hidden">
                  <Image
                    ...
                    alt="Nowoczesna willa nowo wybudowana"
                    fill
                    className="object-cover"
                    unoptimized
                  />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <div className="text-warm-200">Zaufani Deweloperzy</div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-light text-primary-900">
                Co Nas <span className="font-semibold">Wyróżnia</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <ValueCard
                ...
                title="Pełny Wybór"
                description="Dostęp do wszystkich nowych domów na Costa Blanca i Costa Calida. Jeśli się buduje, możemy to pokazać."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title="Zaufana Sieć"
                description="Budowniczowie, architekci, prawnicy, doradcy podatkowi - zgromadziliśmy całą potrzebną drużynę."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title="Weryfikowani Deweloperzy"
                description="Każdy budowniczy, z którym współpracujemy, przeszedł dokładną kontrolę pod kątem jakości i wiarygodności."
              />
              <ValueCard
                icon={
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description="Od pierwszego oglądania po przekazanie kluczy i poza - jesteśmy z tobą na każdym kroku."
              />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-primary-900 mb-4">
                Jak Ci <span className="font-semibold">Pomagamy</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Zakup nowej nieruchomości w Hiszpanii to ekscytująca podróż. Oto jak ją czynimy gładką i bezstresową.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                ...
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Poszukiwanie Nieruchomości</h3>
                <p className="text-warm-600 text-sm">
                  Powiedz nam swoje wymagania i budżet. Wyselekcjonujemy najlepsze nowe opcje z naszego rozszerzonego portfela.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">2</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Oglądanie</h3>
                <p className="text-warm-600 text-sm">
                  Organizujemy i towarzyszymy ci przy oględzinach, dostarczając fachowych informacji o każdej inwestycji i obszarze.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">3</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Fachowe Wskazówki</h3>
                <p className="text-warm-600 text-sm">
                  Obsługujemy wszystkie negocjacje i papierkową robotę w twoim imieniu, korzystając z naszych silnych relacji z deweloperami.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">4</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Wsparcie Prawne</h3>
                <p className="text-warm-600 text-sm">
                  Łączymy cię z zaufanymi prawnikami mówiącymi po angielsku specjalizującymi się w hiszpańskich transakcjach nieruchomościowych.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">5</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Aktualizacje Budowy</h3>
                <p className="text-warm-600 text-sm">
                  Przy zakupach na papierze otrzymujesz regularne aktualizacje postępów budowy ze zdjęciami i raportami.
                </p>
              </div>

              <div className="bg-warm-50 p-6 rounded-sm border border-warm-200">
                <div className="w-10 h-10 bg-primary-900 text-white rounded-full flex items-center justify-center mb-4 font-bold">6</div>
                <h3 className="text-lg font-semibold text-primary-900 mb-2">Przekazanie Kluczy</h3>
                <p className="text-warm-600 text-sm">
                  Uczestniczymy w ostatecznej inspekcji i przekazaniu kluczy z tobą, upewniając się, że wszystko jest doskonałe.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-warm-700 mb-6 leading-relaxed">
                  Pokrywamy całą Costa Blancę od Denii na północy do Torreviei na południu,
                  plus region Costa Calida wokół Murcji. To obejmuje wszystkie popularne obszary dla
                  międzynarodowych kupujących.
                </p>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Costa Blanca Północ</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Costa Blanca Południe</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Torrevieja</li>
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-900 mb-2">Kursy Golfowe</h4>
                    <ul className="text-warm-600 text-sm space-y-1">
                      <li>• Las Colinas</li>
                      <li>• Villamartín</li>
                      <li>• La Finca</li>
              ...
              <div className="bg-primary-900 p-8 rounded-sm text-white">
                ...
                <p className="text-warm-300 mb-6">
                  Gotowy do rozpoczęcia poszukiwania nieruchomości? Skontaktuj się z nami dzisiaj, aby uzyskać bezpłatną konsultację bez zobowiązań.
                </p>
        ...
        <section className="py-16 bg-primary-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
              Gotowy Znaleźć Swój Wymarzony Dom w Hiszpanii?
            </h2>
            <p className="text-warm-300 mb-8 max-w-2xl mx-auto">
              Przeglądaj nasz rozległy portfel nowych nieruchomości lub skontaktuj się z nami w celu spersonalizowanych rekomendacji.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                Wyświetl Wszystkie Nieruchomości
              </Link>
              <a
                href={CONTACT.whatsapp}
                target="_blank"
