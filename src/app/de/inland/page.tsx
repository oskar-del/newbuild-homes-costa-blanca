...
export const metadata: Metadata = {
  title: 'Inland-Immobilien Costa Blanca | Neue Bauten Abseits der Küste',
  description: 'Entdecken Sie Neubauten im Inland von Costa Blanca und Costa Calida. Mehr Platz, bessere Werte und authentisches spanisches Leben in Städten wie Algorfa, Rojales, Polop und mehr.',
  openGraph: {
    title: 'Inland-Immobilien Costa Blanca',
    description: 'Neue Häuser im Inland von Costa Blanca. Mehr Platz, bessere Werte, authentisches Spanien.',
    type: 'website',
  },
  alternates: {
...
export default async function InlandPropertiesPage() {
  ...
  const breadcrumbs = breadcrumbSchema([
    { name: 'Startseite', url: 'https://newbuildhomescostablanca.com/' },
    { name: 'Inland-Immobilien', url: 'https://newbuildhomescostablanca.com/de/inland/' },
  ]);
        ...
        <section className="relative bg-primary-900 py-16 md:py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <nav className="text-warm-400 text-sm mb-6">
              ...
              <span className="text-white">Inland-Immobilien</span>
            </nav>
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                  Mehr Platz • Bessere Werte
                </span>
              </div>

              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
                Neue Bauten <span className="font-semibold">im Inland</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-8">
                Entdecken Sie das Herz Spaniens mit unserer Auswahl an Neubauten im Inland von Costa Blanca.
                Genießen Sie größere Grundstücke, traditionelle Dörfer, Golfplätze und Preise bis zu 40% unter den Küstengebieten
                - alles nur 20-30 Minuten von den Stränden entfernt.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div>
                  ...
                  <div className="text-warm-400 text-sm">Durchschnittspreis</div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-3">
                Warum im <span className="font-semibold">Inland kaufen?</span>
              </h2>
              <p className="text-warm-600 max-w-2xl mx-auto">
                Viele Käufer entdecken, dass die Costa Blanca im Inland erstklassigen Wert und einen authentischeren spanischen Lebensstil bietet.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Bessere Werte</h3>
                <p className="text-warm-600 text-sm">Immobilien können 30-40% günstiger sein als Küstenäquivalente bei gleicher Bauqualität.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Mehr Platz</h3>
                <p className="text-warm-600 text-sm">Größere Grundstücke und Gärten. Viele Immobilien haben 500m²+ Grundstücke im Vergleich zu 100-200m² an der Küste.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">Authentisches Spanien</h3>
                <p className="text-warm-600 text-sm">Traditionelle Dörfer, lokale Märkte und spanische Kultur. Weniger touristisch, mehr authentisch.</p>
              </div>
              ...
              <div className="text-center p-6 bg-warm-50 rounded-sm">
                ...
                <h3 className="font-semibold text-primary-900 mb-2">In der Nähe der Küste</h3>
                <p className="text-warm-600 text-sm">Die meisten Inlandstädte sind nur 20-30 Minuten vom Strand entfernt. Das Beste aus beiden Welten!</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{southInland.length} Immobilien verfügbar</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Blanca <span className="font-semibold">Süd im Inland</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Die Region Vega Baja bietet das beste Preis-Leistungs-Verhältnis in Costa Blanca. Städte wie Algorfa, Rojales und San Miguel de Salinas verbinden hervorragende Golfplätze, traditionelle spanische Märkte und leichten Strandzugang - alles zu Preisen 30-40% unter der Küste.
                  </p>
                </div>
              </div>
              ...
              {southInland.length > 6 && (
                <div className="text-center mt-8">
                  ...
                  >
                    Alle {southInland.length} Süd-Inland-Immobilien anzeigen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{northInland.length} Immobilien</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Blanca <span className="font-semibold">Nord im Inland</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Fliehen Sie in die atemberaubende Weinregion Jalon Valley, die charmante Bergstadt Polop oder das pulsierende La Nucia. Der Norden bietet dramatische Landschaften, kühlere Sommer und eine etabliertere Expat-Gemeinde - perfekt für diejenigen, die einen ruhigeren Lebensstil suchen.
                  </p>
                </div>
              </div>
              ...
              {northInland.length > 6 && (
                <div className="text-center mt-8">
                  ...
                  >
                    Alle {northInland.length} Nord-Inland-Immobilien anzeigen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-warm-500 text-sm">{costaCalidaInland.length} Immobilien</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Costa Calida <span className="font-semibold">im Inland</span>
                  </h2>
                  <p className="text-warm-600 mt-2 leading-relaxed">
                    Die Region Murcia bietet außergewöhnlichen Wert mit mehr spanischem Flair. Städte wie Torre Pacheco und Fuente Álamo bieten authentisches ländliches Leben mit leichtem Zugang zu den Mar Menor-Stränden und der Stadt Murcia.
                  </p>
                </div>
              </div>
              ...
              {costaCalidaInland.length > 6 && (
                <div className="text-center mt-8">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors"
                  >
                    Alle {costaCalidaInland.length} Costa Calida Inland-Immobilien anzeigen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                    Alle <span className="font-semibold">Inland-Immobilien</span>
                  </h2>
                  <p className="text-warm-600 mt-1">
                    Durchsuchen Sie alle {properties.length} Neubauten im Inland
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-3">
                Beliebte Inlandstädte
              </h2>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: 'Algorfa', region: 'Süd', golf: true },
                { name: 'Rojales', region: 'Süd', golf: true },
                { name: 'San Miguel de Salinas', region: 'Süd' },
                { name: 'Benijofar', region: 'Süd' },
                { name: 'Polop', region: 'Nord', mountain: true },
                { name: 'La Nucia', region: 'Nord' },
                { name: 'Jalon Valley', region: 'Nord', wine: true },
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {area.wine && <span className="text-xs bg-purple-500/20 text-purple-400 px-1.5 py-0.5 rounded">Wein</span>}
                  </div>
                </Link>
              ))}
            </div>
        ...
        <section className="py-16 bg-warm-50">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
              Möchten Sie Inland-Optionen erkunden?
            </h2>
            <p className="text-warm-600 leading-relaxed mb-8 max-w-2xl mx-auto">
              Unser Team kann Besichtigungen von Inlandimmobilien arrangieren und Ihnen die Vorteile jedes Bereichs erklären.
              Wir zeigen Ihnen lokale Annehmlichkeiten, Fahrtzeiten zur Küste und helfen Ihnen, das richtige Gleichgewicht zu finden.
            </p>
