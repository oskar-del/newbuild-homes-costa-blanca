...
export const metadata: Metadata = {
  title: 'Regionen Costa Blanca | Leitfäden zum Wohnen und Immobilien',
  description: 'Entdecken Sie die besten Regionen zum Wohnen an der Costa Blanca. Umfassende Leitfäden zu Jávea, Moraira und vielem mehr mit Immobilienangeboten und Lifestyle-Informationen.',
  openGraph: {
    title: 'Regionen Costa Blanca | Leitfäden zum Wohnen und Immobilien',
    description: 'Entdecken Sie die besten Regionen zum Wohnen an der Costa Blanca. Erkunden Sie Jávea, Moraira, Calpe und andere Premium-Standorte.',
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/de/areas',
    siteName: 'New Build Homes Costa Blanca',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Regionen Costa Blanca | Leitfäden zum Wohnen und Immobilien',
    description: 'Entdecken Sie die besten Regionen zum Wohnen an der Costa Blanca. Umfassende Leitfäden zu Topstandorten.',
  },
  alternates: {
    ...
    <main className="min-h-screen bg-warm-50">
      ...
      <section className="relative bg-primary-900 py-16 md:py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <nav className="text-warm-400 text-sm mb-6">
            ...
            <span className="text-white">Regionen</span>
          </nav>
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                Entdecken Sie Ihren idealen Standort
              </span>
            </div>
            ...
            <p className="text-warm-300 text-lg leading-relaxed mb-8">
              Von der erschwinglichen sonnigen Südküste bis zur prestigeträchtigen Nordküste.
              Erkunden Sie unsere detaillierten Leitfäden, um Ihre perfekte Ecke der Costa Blanca zu finden.
            </p>
            ...
            <div className="flex flex-wrap gap-8">
              <div>
                ...
                <div className="text-warm-400 text-sm">Gebietsführer</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-white">320+</div>
                <div className="text-warm-400 text-sm">Sonnentage</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-white">50+ km</div>
                <div className="text-warm-400 text-sm">Strände</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-warm-500 text-xs">Ø Preis</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-accent-400 text-sm font-medium">Bestes Preis-Leistungs-Verhältnis in Spanien</p>
                </div>
                <div className="text-right">
                  <div className="text-lg font-semibold text-white">€179,000</div>
                  <div className="text-warm-400 text-xs">Ø Preis</div>
                </div>
              </div>
              <p className="text-warm-300 text-sm mb-4 line-clamp-2">
                Region Mar Menor in Murcia. Championship Golf, ganzjähriger Sonnenschein, 25-40% günstiger als Costa Blanca.
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-xs">Sonnentage</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-semibold text-white">{southData.stats.golfCourses}</div>
                  <div className="text-warm-400 text-xs">Golfplätze</div>
                </div>
                <div className="text-center">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <div className="text-lg font-semibold text-white">
                            Ab €{area.priceRange.min.toLocaleString()}
                          </div>
                        </div>
                      </div>
                    )}
                    <div className="p-4 bg-primary-900">
                      ...
                      <div className="mt-3 flex items-center justify-between text-sm">
                        {area.propertyCount > 0 && (
                          <span className="text-warm-500">{area.propertyCount} Immobilien</span>
                        )}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {southData.popularTowns.map(town => (
                  <div key={town} className="bg-white p-4 rounded-sm border border-warm-200">
                    ...
                    <p className="text-sm text-warm-500">Gebietsführer in Kürze</p>
                  </div>
                ))}
              </div>
            )}
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-primary-900 font-medium text-lg">Wollen Sie Projekte in diesen Regionen erkunden?</p>
            <p className="text-warm-500 text-sm mt-1">Kontaktieren Sie uns für die neuesten Verfügbarkeiten, Grundrisse oder um eine Besichtigung zu buchen</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                Nicht sicher, welches Gebiet das richtige ist?
              </h2>
              <p className="text-warm-300 leading-relaxed mb-6">
                Bei so vielen fantastischen Orten zur Auswahl kann es überwältigend sein.
                Sagen Sie uns Ihre Prioritäten—Budget, Lebensstil, Nähe zu Strand oder Golf—und
                wir empfehlen Ihnen das perfekte Gebiet für Sie.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-5 rounded-sm">
                ...
                <div className="text-warm-300 text-sm">Jahre lokale Erfahrung</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">500+</div>
                <div className="text-warm-300 text-sm">Familien geholfen</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">Free</div>
                <div className="text-warm-300 text-sm">Kostenlose Beratung</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
                <div className="text-2xl font-semibold text-white mb-1">5</div>
                <div className="text-warm-300 text-sm">Sprachen</div>
              </div>
            </div>
          </div>
        </div>
