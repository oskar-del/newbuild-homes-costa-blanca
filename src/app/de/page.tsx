...
// Export metadata for German homepage
export const metadata: Metadata = {
  title: 'Neubau Costa Blanca | Villas & Wohnungen in Spanien',
  description: 'Finden Sie Ihr Traumhaus an der Costa Blanca, Spanien. Neubauten ab €164.000. Fachhilfe für deutsche Käufer.',
  keywords: 'Neubau Costa Blanca, Haus kaufen Spanien, Villa Costa Blanca, Wohnungen Spanien',
  openGraph: {
    title: 'Neubau Costa Blanca | Villas & Wohnungen in Spanien',
    description: 'Finden Sie Ihr Traumhaus an der Costa Blanca. Neubauten von zuverlässigen Bauträgern.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Luxusvillas und Wohnungen an der Costa Blanca, Spanien',
      },
    ],
  },
  twitter: {
...
// Helper to format price in German locale
...
export default function DeutscheHomepage() {
      ...
      <main className="min-h-screen bg-warm-50">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-center gap-6 text-sm">
              ...
              <span className="text-warm-300 hidden sm:inline">
                Ab <span className="text-accent-400 font-medium">€164.000</span>
              </span>
            ...
            <div className="max-w-7xl mx-auto px-6 pb-6 md:pb-10 w-full">
              ...
              <div className="text-center mb-6">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-2 leading-[1.1]">
                  ...
                  <span className="font-semibold"> Bezugsfertig</span>
                </h1>
                <p className="text-warm-300 max-w-xl mx-auto">
                  Bezugsfertige Immobilien ab €164.000. Ihr mediterraner Lebensstil beginnt hier.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-warm-300 text-sm">
                      {featured.heroLeft.bedrooms} Schlafzimmer · {featured.heroLeft.builtArea}m²
                    </span>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-warm-300 text-sm">
                      {featured.heroRight.bedrooms} Schlafzimmer · {featured.heroRight.builtArea}m²
                    </span>
                  </div>
                </Link>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center mt-5">
                ...
                >
                  Bezugsfertige Immobilien anzeigen
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Neu an der <span className="font-semibold">Costa Blanca?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Wichtige Leitfäden, um fundierte Entscheidungen beim Immobilienkauf in Spanien zu treffen.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    alt="Modernes Neubau-Villeninterieur mit offener Grundrissgestaltung"
                    fill
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    10-jährige Garantie, energieeffizient, keine Makler, modernes Design – entdecken Sie die Vorteile eines Neukaufs.
                  </p>
              ...
              <Link
                href="/de/guides/north-vs-south"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80"
                    alt="Costa-Blanca-Küstenlinie mit blauem Meer und weißen Gebäuden"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Nord vs. Süd Costa Blanca
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Klima, Preise, Expat-Gemeinschaften, Flughäfen – welche Region passt besser zu Ihrem Lebensstil?
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Leitfaden lesen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/de/guides/key-ready-vs-off-plan"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80"
                    alt="Neubauerschließung im Bau an der Costa Blanca"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Bezugsfertig vs. Bauplan
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Jetzt einziehen oder Geld sparen? Vergleichen Sie Vorteile, Nachteile und Zahlungsoptionen.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Leitfaden lesen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Komplette <span className="font-semibold">Wohnführer</span>
              </h2>
              <p className="text-warm-300 mt-2 max-w-xl mx-auto text-sm">
                Die umfassendsten Stadtteilführer im Internet – mit Drohnenfotografie, Immobilienpreisen und Insider-Tipps.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 max-w-6xl mx-auto">
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    ...
                    alt="Luftaufnahme der Küstenlinie von Torrevieja und Strände"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    7 Stadtteile mit Hubschrauber-Drohnenfotografie. Costa Blanca Süd.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">104+ Fotos</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 Zonen</span>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    ...
                    alt="Luftaufnahme der Jávea-Küste mit dem Berg Montgó"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    4 Stadtteile unter dem Berg Montgó. Costa Blanca Nord.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">4 Stadtteile</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">7 Strände</span>
              ...
              <Link
                href="/de/guides/costa-blanca-north"
                className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all"
              >
                <div className="relative h-44 overflow-hidden">
                  <Image
                    src="/images/Area canvas/Calpe.png"
                    alt="Luftaufnahme von Calpe und dem Peñón de Ifach"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-300 text-sm mb-3">
                    6 Städte verglichen mit Drohnenfotografie. Komplette Regionsübersicht.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">6 Städte</span>
                    <span className="text-xs bg-white/10 text-warm-300 px-2 py-0.5 rounded">Regionalguide</span>
                  </div>
                </div>
              </Link>
            </div>
            ...
            <div className="text-center mt-6">
              <Link href="/de/guides" className="text-accent-400 hover:text-accent-300 text-sm font-medium transition-colors">
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[450px]">
            ...
            <Link
              href={`/de/properties/${featured.southVilla1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.southVilla1.bedrooms} Schlafzimmer · {featured.southVilla1.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            <Link
              href={`/de/properties/${featured.southVilla2.reference}`}
              className="group relative h-[350px] md:h-auto overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.southVilla2.bedrooms} Schlafzimmer · {featured.southVilla2.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
        ...
        <section className="relative">
          ...
          <div className="bg-warm-800 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">
                Pinoso-Villas ab €518k
              </h2>
              <p className="text-warm-400 mt-2 text-sm">
                Friedliches Landleben mit privaten Pools, größeren Grundstücken und außergewöhnlichem Wert
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            ...
            <Link
              href={`/de/properties/${featured.inland1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.inland1.bedrooms} Schlafzimmer · {featured.inland1.builtArea}m²
                  </span>
                </div>
            ...
            <Link
              href={`/de/properties/${featured.inland2.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.inland2.bedrooms} Schlafzimmer · {featured.inland2.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Immobilie anzeigen
          ...
          <div className="bg-warm-800 py-4 text-center">
            ...
            >
              Alle Immobilien im Landesinneren erkunden
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-warm-600 leading-relaxed mb-5">
                  Wir arbeiten direkt mit Entwicklern zusammen, prüfen jede Immobilie persönlich
                  und bieten umfassende Unterstützung für internationale Käufer.
                </p>
                <Link
                  href="/de/contact"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Geprüfte Entwickler</h3>
                  <p className="text-warm-600 text-xs">Nur bewährte Erfolgsbilanz.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Mehrsprachig</h3>
                  <p className="text-warm-600 text-xs">DE, EN, SV, FR, NL, ES.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Hypothekenhilfe</h3>
                  <p className="text-warm-600 text-xs">Vergleichen Sie spanische Banken.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-sm border border-warm-200">
                  ...
                  <h3 className="font-medium text-primary-900 mb-1 text-sm">Virtuelle Touren</h3>
                  <p className="text-warm-600 text-xs">Sehen Sie von überall aus.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[550px]">
            ...
            <div className="relative h-[400px] md:h-auto overflow-hidden bg-success-900">
              ...
              <Image
                ...
                alt="La Finca Golfplatz mit Fairways, Springbrunnen und Bergausblick"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
              ...
              <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-12">
                ...
                <h2 className="text-3xl md:text-4xl font-light text-white mb-4 leading-tight">
                  Aufwachen zur<br />
                  <span className="font-semibold">Golfplatzaussicht</span>
                </h2>

                <p className="text-success-100 mb-6 max-w-md leading-relaxed">
                  Wohnen Sie auf Meisterschaftsplätzen bei La Finca, Lo Romero & Vistabella.
                  Ganzjährig Sonne, bezugsfertige Villas und Golf an der Haustür.
                </p>
                ...
                <div className="flex flex-wrap gap-6 mb-6">
                  <div>
                    ...
                    <div className="text-success-200 text-xs uppercase tracking-wide">Golfplätze</div>
                  </div>
                  <div>
                    <div className="text-2xl font-semibold text-white">320</div>
                    <div className="text-success-200 text-xs uppercase tracking-wide">Sonnentage</div>
                  </div>
                  <div>
                    <div className="text-2xl font-semibold text-white">€399k</div>
                    <div className="text-success-200 text-xs uppercase tracking-wide">Ab</div>
                  </div>
                </div>
            ...
            <Link
              href={`/de/properties/${featured.golf1.reference}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.golf1.bedrooms} Schlafzimmer · {featured.golf1.builtArea}m²
                  </span>
                </div>
          ...
          <div className="grid md:grid-cols-2 h-[350px]">
            {/* Golf Property 2 */}
            <Link
              href={`/de/properties/${featured.golf2.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-200 text-xs">
                    {featured.golf2.bedrooms} Schlafzimmer · {featured.golf2.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            {/* Golf Property 3 */}
            <Link
              href={`/de/properties/${carousels['south-golf'].properties[2]?.reference || featured.golf1.reference}`}
              className="group relative overflow-hidden"
            >
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-200 text-xs">
                    {carousels['south-golf'].properties[2]?.bedrooms || featured.golf1.bedrooms} Schlafzimmer · {carousels['south-golf'].properties[2]?.builtArea || featured.golf1.builtArea}m²
                  </span>
                </div>
              </div>
            </Link>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-warm-600 mt-1 text-sm">
                  Jávea, Moraira, Calpe — dramatische Küstenlinien und exklusive Immobilien.
                </p>
              </div>
              <Link
                href="/de/properties?region=costa-blanca-north"
                className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm"
              >
                Norden erkunden
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-14 md:py-18 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Link
                href="/de/guides/kaufprozess"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&q=80"
                    alt="Unterzeichnung von Immobiliendokumenten in Spanien"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Schritt-für-Schritt-Anleitung von der Immobiliensuche bis zur Abwicklung. NIE, Anwälte, Eintragung und Schlüsselübergabe.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Leitfaden lesen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Vollständige Aufschlüsselung der Kaufkosten: IVA, Grunderwerbsteuer, Registrierungsgebühren und laufende Ausgaben.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Leitfaden lesen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/de/guides/hypotheken-spanien"
                className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all"
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&q=80"
                    alt="Hausschlüssel und Hypothekendokumente"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    unoptimized
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                    Spanische Hypotheken für Ausländer
                  </h3>
                  <p className="text-warm-600 text-sm leading-relaxed">
                    Wie Sie eine Hypothek in Spanien erhalten. Anforderungen, Zinssätze und Ausleihungshöhen.
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                    Leitfaden lesen
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-12 bg-warm-100 border-y border-warm-200">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Welcher Käufertyp <span className="font-semibold">sind Sie?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Verschiedene Käufer haben unterschiedliche Bedürfnisse. Finden Sie Leitfäden, die auf Ihre Situation zugeschnitten sind.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                  Erstmals Häuser in Spanien kaufen?
                </h3>
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Alles, was Sie wissen müssen: NIE-Nummer, Kaufprozess, Kosten, rechtliche Anforderungen und Schritt-für-Schritt-Anleitung.
                </p>
              ...
              >
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">
                  Planen Sie, Ihre Immobilie zu vermieten?
                </h3>
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Informieren Sie sich über Tourismusvermietungslizenzen in Valencia. Neue Regeln 2025, Anforderungen, Kosten und wie wir helfen können.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Tourismusvermietungs-Leitfaden
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </span>
              ...
              >
                ...
                <p className="text-warm-600 text-sm leading-relaxed mb-4">
                  Unsicher, welche Küste? Vergleichen Sie Costa Blanca in Alicante mit Costa Cálida in Murcia – Preise, Klima und Lebensstil.
                </p>
                <span className="inline-flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">
                  Vergleich ansehen
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="relative">
          ...
          <div className="bg-primary-900 py-6">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <p className="text-warm-400 mt-2 text-sm">
                Handverlesene Premium-Immobilien in Jávea, Moraira & Costa Blanca Nord
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Left Bespoke Villa */}
            <Link
              href={`/de/properties/${featured.bespokeLeft.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.bespokeLeft.bedrooms} Schlafzimmer · {featured.bespokeLeft.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Immobilie anzeigen
            ...
            {/* Right Bespoke Villa */}
            <Link
              href={`/de/properties/${featured.bespokeRight.reference}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {featured.bespokeRight.bedrooms} Schlafzimmer · {featured.bespokeRight.builtArea}m²
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Immobilie anzeigen
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            {/* Villa Atlantis */}
            <Link
              href={`/de/developments/${miralboVillas.villaAtlantis.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {miralboVillas.villaAtlantis.bedrooms} Schlafzimmer · {miralboVillas.villaAtlantis.builtArea}m² · {miralboVillas.villaAtlantis.plotArea}m² Grundstück
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Immobilie anzeigen
            ...
            {/* Villa Posidonia */}
            <Link
              href={`/de/developments/${miralboVillas.villaPosidonia.slug}`}
              className="group relative overflow-hidden"
            >
              <div
                className="absolute inset-0 bg-cover bg-center bg-fixed"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-warm-300 text-sm">
                    {miralboVillas.villaPosidonia.bedrooms} Schlafzimmer · {miralboVillas.villaPosidonia.builtArea}m² · {miralboVillas.villaPosidonia.plotArea}m² Grundstück
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-2 text-accent-400 text-sm font-medium group-hover:gap-3 transition-all">
                  Immobilie anzeigen
          ...
          <Link
            href={`/de/developments/${miralboVillas.villaMIR0159.slug}`}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 md:right-1/2 p-8">
              ...
              <p className="text-warm-300 text-sm mb-4">{miralboVillas.villaMIR0159.town} — Zeitgenössische Mittelmeerresidenz</p>
              <div className="flex items-center gap-6 mb-4">
                <span className="text-2xl font-semibold text-white">
                  {formatPrice(miralboVillas.villaMIR0159.price)}
                </span>
                <span className="text-warm-300 text-sm">
                  {miralboVillas.villaMIR0159.bedrooms} Schlafzimmer · {miralboVillas.villaMIR0159.bathrooms} Badezimmer · {miralboVillas.villaMIR0159.builtArea}m² · {miralboVillas.villaMIR0159.plotArea}m² Grundstück
                </span>
              </div>
              <div className="flex items-center gap-2 text-accent-400 font-medium group-hover:gap-3 transition-all">
                Entdecken Sie Villa MIR0159
          ...
          <div className="bg-primary-900 py-4 text-center">
            <Link
              href="/de/properties?minPrice=800000"
              className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-400 transition-colors group text-sm"
            >
              Vollständige maßgeschneiderte Kollektion erkunden
              <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
