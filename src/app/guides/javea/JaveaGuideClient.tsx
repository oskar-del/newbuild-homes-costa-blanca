...
const zones: ZoneNavItem[] = [
  { id: 'arenal', name: 'Arenal Beach & Promenade', shortName: 'Arenal' },
  { id: 'old-town', name: 'Old Town (Pueblo)', shortName: 'Old Town' },
  { id: 'port', name: 'Port (Puerto)', shortName: 'Port' },
  { id: 'montanar', name: 'Montañar & Cap Martí', shortName: 'Montañar' },
];

export default function JaveaGuideClient() {
  ...
  return (
    <nav
      ...
      aria-label="Jávea zone navigation"
    >
