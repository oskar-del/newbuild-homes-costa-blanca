...
export const metadata: Metadata = {
  ...
  description: 'Blader door 1000+ nieuwbouwvilla\'s en appartementen te koop op Costa Blanca. Van het zonnige zuiden tot de prestigieuze noordkust. Vind uw Spaanse droomhuis.',
  openGraph: {
    title: 'Koop Nieuwbouw Costa Blanca | Villa\'s & Appartementen Te Koop',
    ...
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl/properties',
  ...
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/nl/properties',
    languages: {
  ...
  keywords: ['koop huis costa blanca', 'nieuwbouw spanje', 'villa costa blanca prijs', 'nieuwbouw huizen spanje', 'woningen costa blanca'],
};
...
const TOWN_DATA: Record<string, { tagline: string; highlights: string[]; image: string }> = {
  ...
  'Torrevieja': {
    ...
    highlights: ['Zoutwatermeren & natuur', 'Buitenlandse gemeenschap het hele jaar', 'Uitstekende zorg', 'Budgetvriendelijk'],
...
const DUTCH_FAQS = [
  ...
  },
  {
    ...
    answer: 'Jaarlijkse kosten omvatten IBI onroerendgoedbelasting (€300-€1.500 afhankelijk van waarde), gemeenschapslasten voor gedeelde voorzieningen (€50-€200/maand), huisverzekerering (€200-€500/jaar) en nutsvoorzieningen. Buitenlandse eigenaren betalen ook jaarlijkse inkomstenbelasting op ingestelde huurwaarde. Totale jaarlijkse operationele kosten liggen doorgaans tussen €2.000-€5.000 afhankelijk van woninggrootte en locatie.'
  },
  {
...
export default async function NLPropertiesPage({
  searchParams,
}: {
  ...
  const breadcrumbs = breadcrumbSchema([
    { name: 'Startpagina', url: 'https://newbuildhomescostablanca.com/nl/' },
    { name: 'Woningen', url: 'https://newbuildhomescostablanca.com/nl/properties/' },
  ]);
  ...
  const collectionSchema = collectionPageSchema({
    ...
    items: properties.slice(0, 20).map(p => ({
      ...
      url: `https://newbuildhomescostablanca.com/nl/properties/${p.ref || p.id}/`,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: toJsonLd(faqSchema(DUTCH_FAQS)) }} />
      ...
      <main className="min-h-screen bg-warm-50">
        ...
        <section className="bg-white border-b border-warm-200 sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-3">
              <Link
                href="/nl/properties?status=key-ready"
              ...
              <Link
                href="/nl/properties?type=apartment"
              ...
              <Link
                href="/nl/properties?type=villa"
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-warm-100 text-primary-900 rounded-full text-sm font-medium hover:bg-warm-200 transition-colors"
              >
                Villa's
              </Link>
              <Link
                href="/nl/properties?maxprice=300000"
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-warm-100 text-primary-900 rounded-full text-sm font-medium hover:bg-warm-200 transition-colors"
              >
                Onder 300.000€
              </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              <div>
                ...
                <p className="text-warm-500 mt-2">Zon het hele jaar door, golfbanen en gevestigde buitenlandse gemeenschappen</p>
              </div>
              <Link href="/nl/properties?region=south" className="hidden md:flex items-center gap-2 text-accent-600 hover:text-accent-700 font-medium">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {southFeatured.slice(0, 6).map(property => (
                <LargePropertyCard key={property.id} property={property} basePath="/nl" />
              ))}
            </div>
            ...
            <div className="flex flex-wrap gap-2.5">
              {topSouthTowns.map(item => (
                <Link
                  key={item.town}
                  href={`/nl/properties?town=${encodeURIComponent(item.town)}`}
            ...
            <Link href="/nl/properties?region=south" className="md:hidden flex items-center justify-center gap-2 text-accent-600 hover:text-accent-700 font-medium mt-6">
              Toon alle {southProperties.length} woningen →
            </Link>
          </div>
        </section>
        ...
        <section className="py-16 bg-warm-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/nl/properties?region=north" className="hidden md:flex items-center gap-2 text-accent-600 hover:text-accent-700 font-medium">
            ...
            <Link href="/nl/properties?region=north" className="md:hidden flex items-center justify-center gap-2 text-accent-600 hover:text-accent-700 font-medium mt-6">
              Toon alle {northProperties.length} woningen →
            </Link>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/nl/properties?region=golf" className="hidden md:flex items-center gap-2 text-accent-600 hover:text-accent-700 font-medium">
            ...
            <Link href="/nl/properties?region=golf" className="md:hidden flex items-center justify-center gap-2 text-accent-600 hover:text-accent-700 font-medium mt-6">
              Toon alle {golfProperties.length} woningen →
            </Link>
          </div>
        </section>

        {/* Dutch Buyer Info Box */}
        <section className="py-8 px-4 bg-warm-50">
          <div className="max-w-4xl mx-auto bg-blue-50 border border-blue-200 rounded-lg p-6 md:p-8">
            <h3 className="text-xl font-semibold text-primary-900 mb-3">Zo koopt u een woning in Spanje</h3>
            <p className="text-warm-600 mb-4">
              Als Nederlandse koper kunt u een Spaanse hypotheek aanvragen via verschillende banken. Wij adviseren u om:
            </p>
            <ul className="space-y-2 text-warm-600 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span className="text-accent-600 font-semibold mt-0.5">•</span>
                <span>Zowel Spaanse hypotheken als opties van Nederlandse banken te verkennen</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="py-16 bg-warm-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/nl/properties?region=inland" className="hidden md:flex items-center gap-2 text-accent-600 hover:text-accent-700 font-medium">
            ...
            <Link href="/nl/properties?region=inland" className="md:hidden flex items-center justify-center gap-2 text-accent-600 hover:text-accent-700 font-medium mt-6">
              Toon alle {inlandProperties.length} woningen →
            </Link>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {towns
                ...
                .map(({ town, count }) => (
                  <Link
                    key={town}
                    href={`/nl/properties?town=${encodeURIComponent(town)}`}
        ...
        <section className="bg-primary-900 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/nl/contact" className="bg-white text-primary-900 px-8 py-3 rounded-md font-medium hover:bg-warm-100 transition-colors">
                Neem Contact Op
              </Link>
...
function LargePropertyCard({ property, basePath = '/nl' }: { property: ParsedProperty; basePath?: string }) {
