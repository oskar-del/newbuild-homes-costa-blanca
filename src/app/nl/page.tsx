...
export const metadata: Metadata = {
  ...
  description: 'Vind uw droomhuis op Costa Blanca, Spanje. Nieuwbouwvilla\'s, appartementen en residentiële complexen vanaf €164.000. Deskundige hulp voor Nederlandse kopers.',
  keywords: 'nieuwbouw costa blanca, huis kopen spanje, woning costa blanca, villa costa blanca, appartementen spanje',
  openGraph: {
    title: 'Nieuwe Huizen Costa Blanca | Villa\'s & Appartementen in Spanje',
    ...
    <>
      ...
      <main className="min-h-screen bg-warm-50">
            ...
            <div className="max-w-7xl mx-auto px-6 pb-6 md:pb-10 w-full">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-warm-300 max-w-xl mx-auto">
                  Direct inzetbare woningen vanaf €164.000. Uw mediterrane levensstijl begint hier.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Waarom <span className="font-semibold">Nederlanders Kiezen voor Costa Blanca</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-2xl mx-auto">
                Van betaalbare luxe tot veilige investeringen — Costa Blanca biedt het beste van twee werelden voor Nederlandse kopers.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                ...
                <ul className="space-y-3 text-warm-700">
                  <li className="flex gap-3">
                    ...
                    <span><strong>300 zonnedagen per jaar</strong> — in plaats van Nederlandse winters</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
              ...
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                ...
                <ul className="space-y-3 text-warm-700">
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                    <span><strong>60-70% goedkoper dan Amsterdam</strong> — dezelfde kwaliteit</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                  ...
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                    <span><strong>Lage onderhoudskosten</strong> — geen verwarming of sneeuwruiming</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                ...
                <ul className="space-y-3 text-warm-700">
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                    <span><strong>10 jaar garantie</strong> — bouwstandaarden zoals in Nederland</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
              ...
              <div className="bg-warm-50 rounded-sm p-6 border border-warm-200">
                ...
                <ul className="space-y-3 text-warm-700">
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                    <span><strong>Gevestigde Nederlandse gemeenschap</strong> — tienduizenden uit het Noorden</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
                    <span><strong>Nederlandse diensten</strong> — artsen, tandartsen, winkels</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-accent-500 font-bold">✓</span>
        ...
        <section className="py-14 bg-warm-50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              ...
              <Link
                href="/nl/properties?maxPrice=400000&isKeyReady=true"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {featured.affordable.map((property) => (
                <Link
                  ...
                  href={`/nl/properties/${property.reference}`}
        ...
        <section className="py-14 bg-primary-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-warm-300 mb-8 text-lg">
              Wij begeleiden u door het gehele koopproces — van het vinden van het juiste huis tot het krijgen van de sleutels. Wij spreken uw taal en begrijpen uw behoeften als Nederlandse koper.
            </p>
        ...
        <section className="py-12 bg-white border-b border-warm-200">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-10">
              <p className="text-warm-600 mb-6">Vertrouwd door kopers uit Nederland, België, Zwitserland & Engeland</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-accent-600 text-sm font-medium">Nederlandse Kopers</p>
              </div>
            </div>
          </div>
        </section>
