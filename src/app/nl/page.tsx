...
// Export metadata for Dutch homepage
export const metadata: Metadata = {
  title: 'Nieuwbouw Costa Blanca | Villa\'s & Appartementen in Spanje',
  description: 'Vind je droomwoning op Costa Blanca, Spanje. Nieuwbouw villa\'s, appartementen en rijtjeshuizen vanaf €164.000. Deskundig advies voor Nederlandse kopers.',
  keywords: 'nieuwbouw Costa Blanca, huizen kopen Spanje, woning Costa Blanca, villa Costa Blanca, appartementen Spanje',
  openGraph: {
    title: 'Nieuwbouw Costa Blanca | Villa\'s & Appartementen in Spanje',
    description: 'Vind je droomwoning op Costa Blanca. Nieuwbouw villa\'s, appartementen en rijtjeshuizen van betrouwbare bouwers.',
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl',
  ...
  twitter: {
    ...
    description: 'Vind je droomwoning op Costa Blanca, Spanje.',
...
// Helper to format price in Dutch locale
      ...
      <main className="min-h-screen bg-warm-50">
            ...
            <div className="max-w-7xl mx-auto px-6 pb-6 md:pb-10 w-full">
              <div className="text-center mb-6">
                ...
                <p className="text-warm-300 max-w-xl mx-auto">
                  Direct beschikbare woningen vanaf €164.000. Je mediterrane levensstijl begint hier.
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-4">
                <Link
                  href={`/nl/properties/${featured.heroLeft.reference}`}
                ...
                <Link
                  href={`/nl/properties/${featured.heroRight.reference}`}
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center mt-5">
                <Link
                  href="/nl/properties?isKeyReady=true"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Essentiële gidsen om je goed geïnformeerde beslissingen te helpen nemen over huizen kopen in Spanje.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/nl/guides/why-new-build" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
              ...
              <Link href="/nl/guides/north-vs-south" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                <div className="relative h-40 overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">Klimaat, prijzen, expatgemeenschappen, luchthavens - welk gebied past beter bij je levensstijl?</p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">Lees Gids <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></div>
                </div>
              </Link>

              <Link href="/nl/guides/key-ready-vs-off-plan" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                <div className="relative h-40 overflow-hidden">
        ...
        <section className="py-14 bg-primary-900">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-5 max-w-6xl mx-auto">
              <Link href="/nl/guides/torrevieja" className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all">
              ...
              <Link href="/nl/guides/javea" className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all">
                <div className="relative h-44 overflow-hidden">
              ...
              <Link href="/nl/guides/costa-blanca-north" className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all">
                <div className="relative h-44 overflow-hidden">
            ...
            <div className="text-center mt-6">
              <Link href="/nl/guides" className="text-accent-400 hover:text-accent-300 text-sm font-medium transition-colors">
                Bekijk Alle Gidsen →
              </Link>
            </div>
          </div>
        ...
        <section className="py-14 md:py-18 bg-warm-50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              ...
              <Link href="/nl/properties?maxPrice=400000&isKeyReady=true" className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm">
                Bekijk Alle
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {featured.affordable.map((property) => (
                <Link key={property.reference} href={`/nl/properties/${property.reference}`} className="group bg-white rounded-sm overflow-hidden hover:shadow-xl transition-all duration-300 border border-warm-100">
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[450px]">
            <Link href={`/nl/properties/${featured.southVilla1.reference}`} className="group relative h-[350px] md:h-auto overflow-hidden">
            ...
            <Link href={`/nl/properties/${featured.southVilla2.reference}`} className="group relative h-[350px] md:h-auto overflow-hidden">
        ...
        <section className="relative">
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            <Link href={`/nl/properties/${featured.inland1.reference}`} className="group relative overflow-hidden">
            ...
            <Link href={`/nl/properties/${featured.inland2.reference}`} className="group relative overflow-hidden">
          ...
          <div className="bg-warm-800 py-4 text-center">
            <Link href="/nl/inland" className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-400 transition-colors group text-sm">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <Link href="/nl/contact" className="inline-flex items-center gap-2 bg-primary-900 text-white px-5 py-2.5 rounded-sm font-medium hover:bg-primary-800 transition-colors group text-sm">
                  Begin een Gesprek
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
        ...
        <section className="relative">
          <div className="grid md:grid-cols-2 min-h-[550px]">
            <div className="relative h-[400px] md:h-auto overflow-hidden bg-success-900">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-12">
                ...
                <Link href="/nl/golf" className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-300 transition-colors group text-sm w-fit">
            ...
            <Link href={`/nl/properties/${featured.golf1.reference}`} className="group relative h-[400px] md:h-auto overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 h-[350px]">
            <Link href={`/nl/properties/${featured.golf2.reference}`} className="group relative overflow-hidden">
            ...
            <Link href={`/nl/properties/${carousels['south-golf'].properties[2]?.reference || featured.golf1.reference}`} className="group relative overflow-hidden">
          ...
          <div className="bg-success-800 py-4 text-center">
            <Link href="/nl/golf" className="inline-flex items-center gap-2 text-white font-medium text-sm hover:text-accent-300 transition-colors group">
        ...
        <section className="py-14 md:py-18 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              ...
              <Link href="/nl/properties?region=costa-blanca-north" className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm">
                Ontdek Noord
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
              {featured.northProperties.map((property) => (
                <Link key={property.reference} href={`/nl/properties/${property.reference}`} className="group">
        ...
        <section className="py-14 md:py-18 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/nl/guides/kopproces" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                <div className="relative h-40 overflow-hidden">
              ...
              <Link href="/nl/guides/kosten-belastingen" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                <div className="relative h-40 overflow-hidden">
              ...
              <Link href="/nl/guides/hypotheken-spanje" className="group relative bg-warm-50 rounded-sm overflow-hidden border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                <div className="relative h-40 overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="text-warm-600 text-sm leading-relaxed">Hoe krijg je een hypotheek in Spanje. Eisen, rentetarieven en hoeveel je kunt lenen.</p>
                  <div className="mt-4 flex items-center gap-2 text-accent-600 text-sm font-medium group-hover:gap-3 transition-all">Lees Gids <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></div>
                </div>
              </Link>
            </div>
            ...
            <div className="text-center mt-8">
              <Link href="/nl/guides" className="inline-flex items-center gap-2 text-primary-900 font-medium hover:text-accent-600 transition-colors group text-sm">
        ...
        <section className="py-12 bg-warm-100 border-y border-warm-200">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-primary-900">
                Welk Type <span className="font-semibold">Koper Ben Je?</span>
              </h2>
              <p className="text-warm-600 mt-2 max-w-xl mx-auto">
                Verschillende kopers hebben verschillende behoeften. Vind gidsen aangepast aan je situatie.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/nl/guides/kopproces" className="group bg-white rounded-sm p-6 border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                ...
                <p className="text-warm-600 text-sm leading-relaxed mb-4">Alles wat je moet weten: NIE-nummer, kopproces, kosten, juridische vereisten en stap-voor-stap begeleiding.</p>
              ...
              <Link href="/nl/guides/torrevieja" className="group bg-white rounded-sm p-6 border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
                ...
                <h3 className="font-semibold text-primary-900 mb-2 group-hover:text-accent-600 transition-colors">Plant je om je woning te verhuren?</h3>
              ...
              <Link href="/nl/areas" className="group bg-white rounded-sm p-6 border border-warm-200 hover:border-accent-500 hover:shadow-lg transition-all">
        ...
        <section className="relative">
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            <Link href={`/nl/properties/${featured.bespokeLeft.reference}`} className="group relative overflow-hidden">
            ...
            <Link href={`/nl/properties/${featured.bespokeRight.reference}`} className="group relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 h-[500px]">
            <Link href={`/nl/developments/${miralboVillas.villaAtlantis.slug}`} className="group relative overflow-hidden">
            ...
            <Link href={`/nl/developments/${miralboVillas.villaPosidonia.slug}`} className="group relative overflow-hidden">
          ...
          <Link href={`/nl/developments/${miralboVillas.villaMIR0159.slug}`} className="group relative block h-[400px] overflow-hidden">
          ...
          <div className="bg-primary-900 py-4 text-center">
            <Link href="/nl/properties?minPrice=800000" className="inline-flex items-center gap-2 text-white font-medium hover:text-accent-400 transition-colors group text-sm">
