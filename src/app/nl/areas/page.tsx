...
export const metadata: Metadata = {
  title: 'Gebieden Costa Blanca | Woonhuisgidsen & Woonhuisgidsen',
  description: 'Ontdek de beste gebieden op Costa Blanca. Uitgebreide gidsen voor Jávea, Moraira, Algorfa en meer met vastgoedlijsten en woonkultuuinformatie voor Nederlandse kopers.',
  openGraph: {
    ...
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl/areas',
  ...
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/nl/areas',
    languages: {
...
export default async function AreasPageNl(): Promise<JSX.Element> {
    ...
    <>
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-accent-400 text-xs font-medium tracking-widest uppercase">
                Vind je ideale locatie
              </span>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4">
              Gebieden op Costa Blanca <span className="font-semibold">- Jouw Gids</span>
            </h1>

            <p className="text-warm-300 text-lg leading-relaxed mb-8">
              Van zonnige zuiden met betaalbare nieuwbouw tot prestigieuze noorden. Verken onze gedetailleerde gidsen om je perfecte hoek van Costa Blanca te vinden.
            </p>
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-4xl mx-auto bg-warm-50 border border-warm-200 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-primary-900 font-medium text-lg">Wil je ontwikkelingen in deze gebieden verkennen?</p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                Twijfel je welk gebied bij je past?
              </h2>
              <p className="text-warm-300 leading-relaxed mb-6">
                Met zoveel fantastische plekken om uit te kiezen kan het overweldigend zijn. Vertel ons je prioriteiten - budget, lifestyle, nabijheid van strand of golf - en wij bevelen je het perfecte gebied aan.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 p-5 rounded-sm">
                ...
                <div className="text-warm-300 text-sm">Consulatie</div>
              </div>
              <div className="bg-white/10 p-5 rounded-sm">
