...
export const metadata: Metadata = {
  ...
  description: 'Verken nieuwbouw over heel Costa Blanca en Costa Calida. Kant-en-klare huizen, golfwoningen en strandnabije wonen. Nederlands service.',
  openGraph: {
    ...
    type: 'website',
    url: 'https://newbuildhomescostablanca.com/nl/developments',
  ...
  alternates: {
    canonical: 'https://newbuildhomescostablanca.com/nl/developments',
    languages: {
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {dev.deliveryQuarter && (
            <div className={`text-[10px] font-medium px-2 py-1 rounded-sm ${
              ...
              {dev.status === 'key-ready' ? 'Nu Inwonen' : dev.deliveryQuarter}
            </div>
          )}
        </div>
...
export default async function DevelopmentsPageNL() {
  ...
  const breadcrumbs = breadcrumbSchema([
    ...
    { name: 'Nieuwbouw', url: 'https://newbuildhomescostablanca.com/nl/developments/' },
  ]);

  // CollectionPage schema for development listings
  const collectionSchema = collectionPageSchema({
    name: 'Nieuwbouw Costa Blanca',
    description: 'Verken nieuwbouw over heel Costa Blanca en Costa Calida. Kant-en-klare huizen, golfwoningen en strandnabije wonen.',
    url: 'https://newbuildhomescostablanca.com/nl/developments/',
      ...
      <main className="min-h-screen bg-warm-50">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <div className="max-w-3xl">
              <nav className="text-warm-400 text-sm mb-6">
                ...
                <span className="text-white">Nieuwbouw</span>
              </nav>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
                Vind Je Perfecte
                <span className="font-semibold block">Nieuwbouwhuis</span>
              </h1>

              <p className="text-warm-300 text-lg leading-relaxed mb-4 max-w-2xl">
                Van de zonnige stranden van Costa Blanca Zuid tot de charmante baaien in het Noorden,
                ontdek {stats.totalDevelopments}+ zorgvuldig geselecteerde nieuwbouw van vertrouwde bouwers.
              </p>

              <p className="text-warm-300 text-base leading-relaxed mb-8 max-w-2xl italic">
                Nederlanders kiezen al jaren Costa Blanca voor hun zonnige droom. Een appartement van 60m² in Amsterdam kost meer dan een villa aan zee hier.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-10">
                <div className="text-center">
                  ...
                  <div className="text-warm-400 text-sm">Nieuwbouw</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-semibold text-accent-400">{keyReady.length}</div>
                  <div className="text-warm-400 text-sm">Kant en Klaar</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-semibold text-white">{stats.builderCount}+</div>
                  <div className="text-warm-400 text-sm">Bouwers</div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-sm p-2 border border-white/20">
                <div className="flex flex-col md:flex-row gap-2">
                  <input
                    type="text"
                    placeholder="Zoek nieuwbouw op naam, stad of bouwer..."
        ...
        <section className="py-8 px-4">
          <div className="max-w-4xl mx-auto bg-accent-50 border-2 border-accent-500 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <p className="text-primary-900 font-bold text-lg">We spreken Nederlands</p>
              <p className="text-warm-700 text-sm mt-1">Ons team is hier om je te helpen je droomhuis te vinden. Met persoonlijke service in je eigen taal.</p>
            </div>
            <div className="flex gap-3">
              ...
              <a href="/nl/contact" className="px-5 py-2.5 border border-primary-900 text-primary-900 rounded-sm text-sm font-medium hover:bg-primary-900 hover:text-white transition-colors">
                Contactformulier
              </a>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    Kant-en-Klare <span className="font-semibold">Nieuwbouw</span>
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Geen wachten, geen vertraging in de bouw. Deze nieuwbouw is klaar voor je om in te trekken.
                    Perfect voor kopers die hun Middellandse Zee avontuur meteen willen beginnen—of je nu wilt genieten van koffie op je terras
                    of een eerste duik in het zwembad wilt nemen.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/nl/developments?status=key-ready"
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors group"
                  >
                    Bekijk Alle {keyReady.length} Kant-en-Klaar
              ...
              <div className="grid md:grid-cols-2 gap-10 mb-10 items-center">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-white mb-4">
                    Dicht bij het Kristalhelder <span className="font-semibold">Middellandse Zee</span>
                  </h2>
                  <p className="text-cyan-100 leading-relaxed mb-4">
                    Ontwaken met kristalhelder water en loop in minuten naar het strand.
                    Van La Zenia tot Torrevieja, deze nieuwbouw ligt vlak aan de beroemde Blue Flag-stranden van Costa Blanca.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4">
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'beachfront').length} Strandnabij
                    </span>
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'walking').length} Loopafstand
                    </span>
                    <span className="bg-cyan-800/50 px-3 py-1 rounded-full text-sm text-cyan-200 border border-cyan-700">
                      {beachProperties.filter(d => d.beachDistance === 'short-drive').length} Korte Rit
                    </span>
                  </div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-sm p-6 text-white border border-white/10">
                  <h3 className="font-semibold text-lg mb-4 text-cyan-200">Waarom Strandnabij Wonen?</h3>
                  <ul className="space-y-3 text-cyan-100">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>15+ Blue Flag-stranden</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>320+ zonnige dagen per jaar</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Kristalhelder Middellandse Zeewaterkwaliteit</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Sterke verhuurpotentieel voor beleggers</span>
                    </li>
                  </ul>
                  <Link
                    href="/nl/beach"
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-8 mb-10">
                <div className="md:col-span-2">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-primary-900 mb-4">
                    <span className="font-semibold">Torrevieja</span> & Omgeving
                  </h2>
                  <p className="text-warm-600 leading-relaxed">
                    Spanje's meest populaire bestemming voor internationale kopers. Met zijn beroemde zoutmeren,
                    bruisende stadskern en uitstekend betaalde onroerend goed, biedt Torrevieja het volledige
                    Middellandse Zee-leven. Slechts 30 minuten van Alicante vliegveld. Een grote Nederlandse gemeenschap maakt het nog gezelliger.
                  </p>
                </div>
                <div className="flex items-end justify-end">
                  <Link
                    href="/nl/areas/torrevieja"
                    className="inline-flex items-center gap-2 text-accent-600 font-medium hover:text-accent-700 transition-colors group"
                  >
                    Verken Torrevieja
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
