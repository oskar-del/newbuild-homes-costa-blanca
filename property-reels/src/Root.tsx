    ...
    <>
      ...
      <Composition
        ...
        defaultProps={{
          ...
          videoPoints: vid("general beach with palm.mp4"),
          videoCTA: vid("sunset.mp4"),
          websiteUrl: "newbuildhomescostablanca.com",
      ...
      <Composition
        ...
        defaultProps={{
          ...
          rentalYield: "5-7%",
          pricePerSqm: 3284,
          videoLocation: vid("passeo alicante vity.mp4"),
          videoInvestment: vid("Marina alicante.mp4"),
          videoCTA: vid("views over alicante marina.mp4"),
          websiteUrl: "newbuildhomescostablanca.com",
          agentName: "Oskar Peterson",
          agentPhone: "+34 634 044 970",
          musicTrack: "music/luxury.mp3",
      ...
      <Composition
        ...
        defaultProps={{
          ...
          images: [
            "vento/edificio-vento-night.png",
            "vento/torrevieja-rooftop-beach-harbour-view-01.jpg",
            "vento/torrevieja-beach-palms-sand-01.jpg",
            "vento/torrevieja-drone-playa-del-cura-beachfront-01.jpg",
          ],
          ...
          rentalYield: "4-6%",
          pricePerSqm: 2382,
          videoLocation: vid("Marina alicante.mp4"),
          videoInvestment: vid("general building 2.mp4"),
          videoCTA: vid("views over alicante marina.mp4"),
          websiteUrl: "newbuildhomescostablanca.com",
          agentName: "Oskar Peterson",
          agentPhone: "+34 634 044 970",
        ...
        defaultProps={{
          ...
          keyPoints: [
            ...
            },
            {
              ...
              image: "vento/torrevieja-rooftop-beach-harbour-view-01.jpg",
            },
          ],
          takeaway:
            "City centre new build from €158K with a 10-min beach walk. Read the full development spotlight on our blog.",
          videoHook: vid("passeo alicante vity.mp4"),
          videoPoints: vid("playa san juan.mp4"),
          videoCTA: vid("views over alicante marina.mp4"),
          websiteUrl: "newbuildhomescostablanca.com",
      ...
      <Composition
        ...
        defaultProps={{
          ...
          videoHero: vid("passeo alicante vity.mp4"),
          videoLifestyle: vid("playa san juan.mp4"),
          videoAmenities: vid("Marina alicante.mp4"),
          videoInvestment: vid("general building 2.mp4"),
          videoDayInLife: vid("views over alicante marina.mp4"),
          videoCTA: vid("water on rock.mp4"),
          websiteUrl: "newbuildhomescostablanca.com",
          musicTrack: "music/chill.mp3",
        }}
      />
      ...
      <Composition
        ...
        defaultProps={{
          ...
          videoHook: vid("water on rock.mp4"),
          videoStats: vid("general building 2.mp4"),
          videoCTA: vid("views over alicante marina.mp4"),
          heroImage: "vento/edificio-vento-exterior.png",
          websiteUrl: "newbuildhomescostablanca.com",
          musicTrack: "music/luxury.mp3",
        }}
      />
      ...
      <Still
        ...
        height={1350}
        defaultProps={{
          image: "vento/torrevieja-playa-del-cura-promenade-01.jpg",
          locationName: "Torrevieja",
          tagline: "New Builds From €158,000",
          websiteUrl: "newbuildhomescostablanca.com",
        }}
